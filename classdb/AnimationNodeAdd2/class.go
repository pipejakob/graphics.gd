...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeAdd2{gdclass.NewAnimationNodeAdd2(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAnimationNodeAdd2(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AnimationNodeAdd2{gdclass.NewAnimationNodeAdd2(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func init() {
	gdclass.Register("AnimationNodeAdd2", func(ptr gdreference.Object) any { return Instance{gdclass.NewAnimationNodeAdd2(ptr)} })
}
