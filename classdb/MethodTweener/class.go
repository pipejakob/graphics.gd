...
[Tween.TweenMethod]: https://pkg.go.dev/graphics.gd/classdb/Tween#Instance.TweenMethod
*/
...
func init() {
	gdclass.Register("MethodTweener", func(ptr gdreference.Object) any { return Instance{gdclass.NewMethodTweener(ptr)} })
}
