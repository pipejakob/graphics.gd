...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RDUniform{gdclass.NewRDUniform(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetRDUniform(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RDUniform{gdclass.NewRDUniform(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o Instance) AsRDUniform() Instance      { return o }
func (o *Extension[T]) AsRDUniform() Instance { return o.Super() }
...
func init() {
	gdclass.Register("RDUniform", func(ptr gdreference.Object) any { return Instance{gdclass.NewRDUniform(ptr)} })
}
