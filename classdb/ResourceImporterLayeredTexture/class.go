...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ResourceImporterLayeredTexture")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterLayeredTexture{gdclass.NewResourceImporterLayeredTexture(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetResourceImporterLayeredTexture(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterLayeredTexture{gdclass.NewResourceImporterLayeredTexture(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsResourceImporterLayeredTexture() Advanced         { return Advanced(o) }
...
func init() {
	gdclass.Register("ResourceImporterLayeredTexture", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceImporterLayeredTexture(ptr)} })
}
