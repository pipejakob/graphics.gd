...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("HFlowContainer")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewHFlowContainer(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.HFlowContainer{gdclass.NewHFlowContainer(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetHFlowContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.HFlowContainer{gdclass.NewHFlowContainer(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsHFlowContainer() Advanced                      { return Advanced(o) }
func (o Instance) AsHFlowContainer() Instance                   { return o }
func (o *Extension[T]) AsHFlowContainer() Instance              { return o.Super() }
func (o class) AsFlowContainer() FlowContainer.Advanced         { return FlowContainer.Advanced{gdclass.NewFlowContainer(o[0].AsObject()[0])} }
...
func (o Instance) AsFlowContainer() FlowContainer.Instance {
	return FlowContainer.Instance{gdclass.NewFlowContainer(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("HFlowContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewHFlowContainer(ptr)} })
}
