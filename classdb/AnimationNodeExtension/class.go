...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeExtension{gdclass.NewAnimationNodeExtension(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
