...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeUVPolarCoord")
...
type Advanced = class
type class [1]gdclass.VisualShaderNodeUVPolarCoord

func (o class) AsObject() [1]gdreference.Object { return *(*[1]gdreference.Object)(ie.As(&o)) }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeUVPolarCoord(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeUVPolarCoord{gdclass.NewVisualShaderNodeUVPolarCoord(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeUVPolarCoord(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUVPolarCoord{gdclass.NewVisualShaderNodeUVPolarCoord(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVisualShaderNodeUVPolarCoord() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeUVPolarCoord() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeUVPolarCoord() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeUVPolarCoord", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeUVPolarCoord(ptr)} })
}
