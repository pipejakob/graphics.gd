...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewAudioStreamPlayer(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamPlayer{gdclass.NewAudioStreamPlayer(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioStreamPlayer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioStreamPlayer{gdclass.NewAudioStreamPlayer(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o Instance) AsAudioStreamPlayer() Instance      { return o }
func (o *Extension[T]) AsAudioStreamPlayer() Instance { return o.Super() }
...
func init() {
	gdclass.Register("AudioStreamPlayer", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamPlayer(ptr)} })
}
