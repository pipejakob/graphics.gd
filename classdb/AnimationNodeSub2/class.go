...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewAnimationNodeSub2(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeSub2{gdclass.NewAnimationNodeSub2(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAnimationNodeSub2(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AnimationNodeSub2{gdclass.NewAnimationNodeSub2(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsAnimationNodeSub2() Advanced         { return Advanced(o) }
func (o Instance) AsAnimationNodeSub2() Instance      { return o }
func (o *Extension[T]) AsAnimationNodeSub2() Instance { return o.Super() }
...
func init() {
	gdclass.Register("AnimationNodeSub2", func(ptr gdreference.Object) any { return Instance{gdclass.NewAnimationNodeSub2(ptr)} })
}
