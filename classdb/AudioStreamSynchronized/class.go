...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamSynchronized{gdclass.NewAudioStreamSynchronized(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
