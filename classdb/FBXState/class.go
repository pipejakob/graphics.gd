...
func (o class) AsGLTFState() GLTFState.Advanced         { return GLTFState.Advanced{gdclass.NewGLTFState(o[0].AsObject()[0])} }
func (o *Extension[T]) AsGLTFState() GLTFState.Instance { return o.Super().AsGLTFState() }
func (o Instance) AsGLTFState() GLTFState.Instance      { return GLTFState.Instance{gdclass.NewGLTFState(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("FBXState", func(ptr gdreference.Object) any { return Instance{gdclass.NewFBXState(ptr)} })
}
