...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDShaderFile{gdclass.NewRDShaderFile(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) SetBytecode(bytecode [1]gdclass.RDShaderSPIRV, version String.Name) { //gd:RDShaderFile.set_bytecode
	...
	runtime.KeepAlive(bytecode[0].Anchor())
