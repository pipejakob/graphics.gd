...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("PacketPeer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PacketPeer{gdclass.NewPacketPeer(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
