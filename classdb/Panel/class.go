...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("Panel")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Panel{gdclass.NewPanel(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetPanel(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Panel{gdclass.NewPanel(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsPanel() Advanced                         { return Advanced(o) }
func (o Instance) AsPanel() Instance                      { return o }
func (o *Extension[T]) AsPanel() Instance                 { return o.Super() }
...
func init() {
	gdclass.Register("Panel", func(ptr gdreference.Object) any { return Instance{gdclass.NewPanel(ptr)} })
}
