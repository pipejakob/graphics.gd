...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisibleOnScreenEnabler3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisibleOnScreenEnabler3D{gdclass.NewVisibleOnScreenEnabler3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
