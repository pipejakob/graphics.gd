...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AnimationNodeAdd3")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewAnimationNodeAdd3(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeAdd3{gdclass.NewAnimationNodeAdd3(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAnimationNodeAdd3(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (o class) AsAnimationNodeAdd3() Advanced         { return Advanced(o) }
func (o Instance) AsAnimationNodeAdd3() Instance      { return o }
func (o *Extension[T]) AsAnimationNodeAdd3() Instance { return o.Super() }
...
func init() {
	gdclass.Register("AnimationNodeAdd3", func(ptr gdreference.Object) any { return Instance{gdclass.NewAnimationNodeAdd3(ptr)} })
}
