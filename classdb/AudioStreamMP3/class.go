...
[Data]: https://pkg.go.dev/graphics.gd/classdb/AudioStreamMP3#Instance.Data
[ResourceImporterMP3]: https://pkg.go.dev/graphics.gd/classdb/ResourceImporterMP3
*/
...
var methods struct {
	load_from_buffer gdextension.MethodForClass `hash:"1674970313"`
	load_from_file   gdextension.MethodForClass `hash:"4238362998"`
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AudioStreamMP3")
...
[AudioStreamMP3]: https://pkg.go.dev/graphics.gd/classdb/AudioStreamMP3
*/
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamMP3{gdclass.NewAudioStreamMP3(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioStreamMP3(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioStreamMP3{gdclass.NewAudioStreamMP3(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
[AudioStreamPlaylist]: https://pkg.go.dev/graphics.gd/classdb/AudioStreamPlaylist
*/
...
/*
If true, the stream will play again from the specified [LoopOffset] once it reaches the end of the audio track, or once it reaches the end of the last beat according to the amount specified in [BeatCount]. Useful for ambient sounds and background music.

[BeatCount]: https://pkg.go.dev/graphics.gd/classdb/AudioStreamMP3#Instance.BeatCount
[LoopOffset]: https://pkg.go.dev/graphics.gd/classdb/AudioStreamMP3#Instance.LoopOffset
*/
...
func init() {
	gdclass.Register("AudioStreamMP3", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamMP3(ptr)} })
}
