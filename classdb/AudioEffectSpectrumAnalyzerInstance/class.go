...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectSpectrumAnalyzerInstance{gdclass.NewAudioEffectSpectrumAnalyzerInstance(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
