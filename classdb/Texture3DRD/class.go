...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Texture3DRD{gdclass.NewTexture3DRD(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetTexture3DRD(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Texture3DRD{gdclass.NewTexture3DRD(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func init() {
	gdclass.Register("Texture3DRD", func(ptr gdreference.Object) any { return Instance{gdclass.NewTexture3DRD(ptr)} })
}
