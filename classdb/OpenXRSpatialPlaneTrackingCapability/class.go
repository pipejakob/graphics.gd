...
*/
package OpenXRSpatialPlaneTrackingCapability
...
type Instance [1]gdclass.OpenXRSpatialPlaneTrackingCapability
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("OpenXRSpatialPlaneTrackingCapability")
...
type Any interface {
	gd.IsClass
	AsOpenXRSpatialPlaneTrackingCapability() Instance
}
...
type Advanced = class
type class [1]gdclass.OpenXRSpatialPlaneTrackingCapability

func (o class) AsObject() [1]gdreference.Object { return *(*[1]gdreference.Object)(ie.As(&o)) }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewOpenXRSpatialPlaneTrackingCapability(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRSpatialPlaneTrackingCapability{gdclass.NewOpenXRSpatialPlaneTrackingCapability(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetOpenXRSpatialPlaneTrackingCapability(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRSpatialPlaneTrackingCapability{gdclass.NewOpenXRSpatialPlaneTrackingCapability(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o Instance) AsOpenXRSpatialPlaneTrackingCapability() Instance      { return o }
func (o *Extension[T]) AsOpenXRSpatialPlaneTrackingCapability() Instance { return o.Super() }
...
func init() {
	gdclass.Register("OpenXRSpatialPlaneTrackingCapability", func(ptr gdreference.Object) any {
		return Instance{gdclass.NewOpenXRSpatialPlaneTrackingCapability(ptr)}
	})
}
