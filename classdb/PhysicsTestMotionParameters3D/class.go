...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsTestMotionParameters3D{gdclass.NewPhysicsTestMotionParameters3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
