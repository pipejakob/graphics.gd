...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AnimationNodeBlend3")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewAnimationNodeBlend3(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeBlend3{gdclass.NewAnimationNodeBlend3(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAnimationNodeBlend3(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AnimationNodeBlend3{gdclass.NewAnimationNodeBlend3(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsAnimationNodeBlend3() Advanced         { return Advanced(o) }
func (o Instance) AsAnimationNodeBlend3() Instance      { return o }
func (o *Extension[T]) AsAnimationNodeBlend3() Instance { return o.Super() }
...
func init() {
	gdclass.Register("AnimationNodeBlend3", func(ptr gdreference.Object) any { return Instance{gdclass.NewAnimationNodeBlend3(ptr)} })
}
