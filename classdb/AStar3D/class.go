...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AStar3D{gdclass.NewAStar3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAStar3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func init() {
	gdclass.Register("AStar3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewAStar3D(ptr)} })
}
