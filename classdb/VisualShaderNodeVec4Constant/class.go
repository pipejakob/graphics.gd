...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVec4Constant{gdclass.NewVisualShaderNodeVec4Constant(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeVec4Constant(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec4Constant{gdclass.NewVisualShaderNodeVec4Constant(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetConstant() Quaternion.IJKX { //gd:VisualShaderNodeVec4Constant.get_constant
	var r_ret = jumponly.Call[Quaternion.IJKX](gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeQuaternion, &struct{}{})
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeVec4Constant() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeVec4Constant() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeVec4Constant() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeVec4Constant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec4Constant(ptr)} })
}
