...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("PlaneMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaneMesh{gdclass.NewPlaneMesh(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
