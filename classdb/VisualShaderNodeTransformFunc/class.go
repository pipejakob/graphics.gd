...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeTransformFunc")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformFunc{gdclass.NewVisualShaderNodeTransformFunc(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
