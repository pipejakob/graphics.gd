...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewMissingResource(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.MissingResource{gdclass.NewMissingResource(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetMissingResource(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.MissingResource{gdclass.NewMissingResource(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsMissingResource() Advanced           { return Advanced(o) }
func (o Instance) AsMissingResource() Instance        { return o }
func (o *Extension[T]) AsMissingResource() Instance   { return o.Super() }
...
func init() {
	gdclass.Register("MissingResource", func(ptr gdreference.Object) any { return Instance{gdclass.NewMissingResource(ptr)} })
}
