...
/*
InputEventShortcut is a special event that can be received in [Node.Input], [Node.ShortcutInput], and [Node.UnhandledInput]. It is typically sent by the editor's Command Palette to trigger actions, but can also be sent manually using [Viewport.PushInput].
...
func init() {
	gdclass.Register("InputEventShortcut", func(ptr gdreference.Object) any { return Instance{gdclass.NewInputEventShortcut(ptr)} })
}
