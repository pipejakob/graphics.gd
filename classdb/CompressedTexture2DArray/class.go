...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("CompressedTexture2DArray")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CompressedTexture2DArray{gdclass.NewCompressedTexture2DArray(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetCompressedTexture2DArray(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CompressedTexture2DArray{gdclass.NewCompressedTexture2DArray(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsCompressedTexture2DArray() Advanced         { return Advanced(o) }
...
func init() {
	gdclass.Register("CompressedTexture2DArray", func(ptr gdreference.Object) any { return Instance{gdclass.NewCompressedTexture2DArray(ptr)} })
}
