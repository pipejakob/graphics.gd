...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("PhysicsRayQueryParameters2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsRayQueryParameters2D{gdclass.NewPhysicsRayQueryParameters2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
