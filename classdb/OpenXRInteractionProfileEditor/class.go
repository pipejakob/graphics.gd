...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRInteractionProfileEditor{gdclass.NewOpenXRInteractionProfileEditor(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetOpenXRInteractionProfileEditor(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfileEditor{gdclass.NewOpenXRInteractionProfileEditor(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsOpenXRInteractionProfileEditor() Advanced         { return Advanced(o) }
...
func init() {
	gdclass.Register("OpenXRInteractionProfileEditor", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRInteractionProfileEditor(ptr)} })
}
