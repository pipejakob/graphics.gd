...
func (Instance) _get_option_visibility(impl func(ptr gdclass.Receiver, path string, option_name string, options map[string]any) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var path = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
		defer pointers.End(gd.InternalString(path))
		var option_name = String.Name(String.Via(gd.WrapStringName(pointers.Pin(pointers.New[gd.StringName](gd.UnsafeGet[gdextension.StringName](p_args, 1))))))
...
func (Instance) _import(impl func(ptr gdclass.Receiver, source_file string, save_path string, options map[string]any, platform_variants []string, gen_files []string) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var source_file = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
		defer pointers.End(gd.InternalString(source_file))
		var save_path = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 1)))))
		defer pointers.End(gd.InternalString(save_path))
		var options = Dictionary.Through(gd.WrapDictionary[variant.Any, variant.Any](pointers.Pin(pointers.New[gd.Dictionary](gd.UnsafeGet[gdextension.Dictionary](p_args, 2)))))
		defer pointers.End(gd.InternalDictionary(options))
		var platform_variants = Array.Through(gd.WrapArray[String.Readable](pointers.Pin(pointers.New[gd.Array](gd.UnsafeGet[gdextension.Array](p_args, 3)))))
		defer pointers.End(gd.InternalArray(platform_variants))
		var gen_files = Array.Through(gd.WrapArray[String.Readable](pointers.Pin(pointers.New[gd.Array](gd.UnsafeGet[gdextension.Array](p_args, 4)))))
...
func (self class) AppendImportExternalResource(path String.Readable, custom_options Dictionary.Any, custom_importer String.Readable, generator_parameters variant.Any) Error.Code { //gd:EditorImportPlugin.append_import_external_resource
	...
	runtime.KeepAlive(custom_options)
	runtime.KeepAlive(custom_importer)
	runtime.KeepAlive(generator_parameters)
