...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeDerivativeFunc{gdclass.NewVisualShaderNodeDerivativeFunc(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
