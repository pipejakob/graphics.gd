...
var methods struct {
	set_function gdextension.MethodForClass `hash:"765791915"`
	get_function gdextension.MethodForClass `hash:"3772902164"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeUVFunc")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeUVFunc(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeUVFunc{gdclass.NewVisualShaderNodeUVFunc(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeUVFunc(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUVFunc{gdclass.NewVisualShaderNodeUVFunc(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) Function() Function { //gd:VisualShaderNodeUVFunc.function
...
func (self Instance) SetFunction(value Function) Instance { //gd:VisualShaderNodeUVFunc.function
...
func (o class) AsVisualShaderNodeUVFunc() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeUVFunc() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeUVFunc() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeUVFunc", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeUVFunc(ptr)} })
}
