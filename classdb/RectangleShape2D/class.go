...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("RectangleShape2D")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RectangleShape2D{gdclass.NewRectangleShape2D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetRectangleShape2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RectangleShape2D{gdclass.NewRectangleShape2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) Size() Vector2.XY { //gd:RectangleShape2D.size
...
func init() {
	gdclass.Register("RectangleShape2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewRectangleShape2D(ptr)} })
}
