...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeLinearSceneDepth")
...
type Advanced = class
type class [1]gdclass.VisualShaderNodeLinearSceneDepth

func (o class) AsObject() [1]gdreference.Object { return *(*[1]gdreference.Object)(ie.As(&o)) }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeLinearSceneDepth(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeLinearSceneDepth{gdclass.NewVisualShaderNodeLinearSceneDepth(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeLinearSceneDepth(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeLinearSceneDepth{gdclass.NewVisualShaderNodeLinearSceneDepth(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVisualShaderNodeLinearSceneDepth() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeLinearSceneDepth() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeLinearSceneDepth() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeLinearSceneDepth", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeLinearSceneDepth(ptr)} })
}
