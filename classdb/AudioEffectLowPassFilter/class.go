...
/*
A "low-pass" filter attenuates frequencies higher than [AudioEffectFilter.CutoffHz] and allows lower frequencies to pass unchanged.
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AudioEffectLowPassFilter")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectLowPassFilter{gdclass.NewAudioEffectLowPassFilter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioEffectLowPassFilter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectLowPassFilter{gdclass.NewAudioEffectLowPassFilter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsAudioEffectLowPassFilter() Advanced         { return Advanced(o) }
func (o Instance) AsAudioEffectLowPassFilter() Instance      { return o }
func (o *Extension[T]) AsAudioEffectLowPassFilter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("AudioEffectLowPassFilter", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectLowPassFilter(ptr)} })
}
