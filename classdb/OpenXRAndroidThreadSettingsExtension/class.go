...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRAndroidThreadSettingsExtension{gdclass.NewOpenXRAndroidThreadSettingsExtension(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
