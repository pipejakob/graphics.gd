...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("HSplitContainer")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.HSplitContainer{gdclass.NewHSplitContainer(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetHSplitContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.HSplitContainer{gdclass.NewHSplitContainer(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsHSplitContainer() Advanced         { return Advanced(o) }
func (o Instance) AsHSplitContainer() Instance      { return o }
func (o *Extension[T]) AsHSplitContainer() Instance { return o.Super() }
func (o class) AsSplitContainer() SplitContainer.Advanced {
	return SplitContainer.Advanced{gdclass.NewSplitContainer(o[0].AsObject()[0])}
}
func (o *Extension[T]) AsSplitContainer() SplitContainer.Instance {
	return o.Super().AsSplitContainer()
}
func (o Instance) AsSplitContainer() SplitContainer.Instance {
	return SplitContainer.Instance{gdclass.NewSplitContainer(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("HSplitContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewHSplitContainer(ptr)} })
}
