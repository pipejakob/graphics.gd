...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AudioStreamPlaybackPlaylist")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamPlaybackPlaylist{gdclass.NewAudioStreamPlaybackPlaylist(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioStreamPlaybackPlaylist(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackPlaylist{gdclass.NewAudioStreamPlaybackPlaylist(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func init() {
	gdclass.Register("AudioStreamPlaybackPlaylist", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamPlaybackPlaylist(ptr)} })
}
