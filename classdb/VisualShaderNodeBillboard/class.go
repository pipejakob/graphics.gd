...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBillboard{gdclass.NewVisualShaderNodeBillboard(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
