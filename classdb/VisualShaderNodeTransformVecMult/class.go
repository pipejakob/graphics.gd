...
var methods struct {
	set_operator gdextension.MethodForClass `hash:"1785665912"`
	get_operator gdextension.MethodForClass `hash:"1622088722"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeTransformVecMult")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeTransformVecMult(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTransformVecMult{gdclass.NewVisualShaderNodeTransformVecMult(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeTransformVecMult(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformVecMult{gdclass.NewVisualShaderNodeTransformVecMult(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsVisualShaderNodeTransformVecMult() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeTransformVecMult() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeTransformVecMult() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeTransformVecMult", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTransformVecMult(ptr)} })
}
