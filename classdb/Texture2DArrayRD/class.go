...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("Texture2DArrayRD")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewTexture2DArrayRD(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Texture2DArrayRD{gdclass.NewTexture2DArrayRD(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetTexture2DArrayRD(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Texture2DArrayRD{gdclass.NewTexture2DArrayRD(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsTexture2DArrayRD() Advanced         { return Advanced(o) }
func (o Instance) AsTexture2DArrayRD() Instance      { return o }
func (o *Extension[T]) AsTexture2DArrayRD() Instance { return o.Super() }
...
func init() {
	gdclass.Register("Texture2DArrayRD", func(ptr gdreference.Object) any { return Instance{gdclass.NewTexture2DArrayRD(ptr)} })
}
