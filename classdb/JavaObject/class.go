...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.JavaObject{gdclass.NewJavaObject(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetJavaObject(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.JavaObject{gdclass.NewJavaObject(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (self class) GetJavaClass() [1]gdclass.JavaClass { //gd:JavaObject.get_java_class
	var r_ret = jumponly.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_java_class, gdextension.SizeObject, &struct{}{})
	var ret = [1]gdclass.JavaClass{gdclass.NewJavaClass(gd.PointerWithOwnershipTransferredToGo(r_ret))}
	return ret
}
func (self class) HasJavaMethod(method String.Name) bool { //gd:JavaObject.has_java_method
...
func (o class) AsJavaObject() Advanced         { return Advanced(o) }
func (o Instance) AsJavaObject() Instance      { return o }
func (o *Extension[T]) AsJavaObject() Instance { return o.Super() }
...
func init() {
	gdclass.Register("JavaObject", func(ptr gdreference.Object) any { return Instance{gdclass.NewJavaObject(ptr)} })
}
