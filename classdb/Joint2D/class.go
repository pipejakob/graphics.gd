...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Joint2D{gdclass.NewJoint2D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetJoint2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Joint2D{gdclass.NewJoint2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsJoint2D() Advanced                       { return Advanced(o) }
func (o Instance) AsJoint2D() Instance                    { return o }
func (o *Extension[T]) AsJoint2D() Instance               { return o.Super() }
...
func init() {
	gdclass.Register("Joint2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewJoint2D(ptr)} })
}
