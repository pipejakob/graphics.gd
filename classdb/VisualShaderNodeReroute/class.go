...
var methods struct {
	get_port_type gdextension.MethodForClass `hash:"1287173294"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeReroute")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeReroute(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeReroute{gdclass.NewVisualShaderNodeReroute(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeReroute(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeReroute{gdclass.NewVisualShaderNodeReroute(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetPortType() VisualShaderNode.PortType { //gd:VisualShaderNodeReroute.get_port_type
	var r_ret = jumponly.Call[VisualShaderNode.PortType](gd.ObjectChecked(self.AsObject()), methods.get_port_type, gdextension.SizeInt, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeReroute() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeReroute() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeReroute() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeReroute", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeReroute(ptr)} })
}
