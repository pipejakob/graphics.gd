...
var methods struct {
	set_use_top_left  gdextension.MethodForClass `hash:"2586408642"`
	is_using_top_left gdextension.MethodForClass `hash:"36873697"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("CenterContainer")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewCenterContainer(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CenterContainer{gdclass.NewCenterContainer(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetCenterContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CenterContainer{gdclass.NewCenterContainer(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) IsUsingTopLeft() bool { //gd:CenterContainer.is_using_top_left
	var r_ret = jumponly.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_using_top_left, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (o class) AsCenterContainer() Advanced               { return Advanced(o) }
func (o Instance) AsCenterContainer() Instance            { return o }
func (o *Extension[T]) AsCenterContainer() Instance       { return o.Super() }
...
func init() {
	gdclass.Register("CenterContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewCenterContainer(ptr)} })
}
