...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VFlowContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VFlowContainer{gdclass.NewVFlowContainer(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
