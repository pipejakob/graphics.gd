...
[SeparationRayShape2D]: https://pkg.go.dev/graphics.gd/classdb/SeparationRayShape2D
*/
...
func init() {
	gdclass.Register("SeparationRayShape2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewSeparationRayShape2D(ptr)} })
}
