...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("CompressedTexture3D")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewCompressedTexture3D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CompressedTexture3D{gdclass.NewCompressedTexture3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetCompressedTexture3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CompressedTexture3D{gdclass.NewCompressedTexture3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
[CompressedTexture3D]: https://pkg.go.dev/graphics.gd/classdb/CompressedTexture3D
*/
func (self Instance) LoadPath() string { //gd:CompressedTexture3D.load_path
...
func (self Instance) SetLoadPath(value string) Instance { //gd:CompressedTexture3D.load_path
...
func (o class) AsCompressedTexture3D() Advanced         { return Advanced(o) }
func (o Instance) AsCompressedTexture3D() Instance      { return o }
func (o *Extension[T]) AsCompressedTexture3D() Instance { return o.Super() }
func (o class) AsTexture3D() Texture3D.Advanced         { return Texture3D.Advanced{gdclass.NewTexture3D(o[0].AsObject()[0])} }
func (o *Extension[T]) AsTexture3D() Texture3D.Instance { return o.Super().AsTexture3D() }
func (o Instance) AsTexture3D() Texture3D.Instance      { return Texture3D.Instance{gdclass.NewTexture3D(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("CompressedTexture3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCompressedTexture3D(ptr)} })
}
