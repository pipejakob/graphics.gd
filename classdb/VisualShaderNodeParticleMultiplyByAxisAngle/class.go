...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleMultiplyByAxisAngle{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeParticleMultiplyByAxisAngle(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleMultiplyByAxisAngle{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) IsDegreesMode() bool { //gd:VisualShaderNodeParticleMultiplyByAxisAngle.is_degrees_mode
	var r_ret = jumponly.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_degrees_mode, gdextension.SizeBool, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeParticleMultiplyByAxisAngle() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeParticleMultiplyByAxisAngle() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeParticleMultiplyByAxisAngle() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeParticleMultiplyByAxisAngle", func(ptr gdreference.Object) any {
		return Instance{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(ptr)}
	})
}
