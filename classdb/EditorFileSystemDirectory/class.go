...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorFileSystemDirectory{gdclass.NewEditorFileSystemDirectory(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
