...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("FramebufferCacheRD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FramebufferCacheRD{gdclass.NewFramebufferCacheRD(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
