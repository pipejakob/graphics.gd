...
func (o Instance) AsWorldEnvironment() Instance      { return o }
func (o *Extension[T]) AsWorldEnvironment() Instance { return o.Super() }
...
func init() {
	gdclass.Register("WorldEnvironment", func(ptr gdreference.Object) any { return Instance{gdclass.NewWorldEnvironment(ptr)} })
}
