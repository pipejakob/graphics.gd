...
/*
Class representing a square [PrimitiveMesh]. This flat mesh does not have a thickness. By default, this mesh is aligned on the X and Y axes; this rotation is more suited for use with billboarded materials. A [QuadMesh] is equivalent to a [PlaneMesh] except its default [PlaneMesh.Orientation] is [Planemesh.FaceZ].

[PlaneMesh]: https://pkg.go.dev/graphics.gd/classdb/PlaneMesh
[PlaneMesh.Orientation]: https://pkg.go.dev/graphics.gd/classdb/PlaneMesh#Instance.Orientation
...
func (o class) AsPlaneMesh() PlaneMesh.Advanced                 { return PlaneMesh.Advanced{gdclass.NewPlaneMesh(o[0].AsObject()[0])} }
func (o *Extension[T]) AsPlaneMesh() PlaneMesh.Instance         { return o.Super().AsPlaneMesh() }
func (o Instance) AsPlaneMesh() PlaneMesh.Instance              { return PlaneMesh.Instance{gdclass.NewPlaneMesh(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("QuadMesh", func(ptr gdreference.Object) any { return Instance{gdclass.NewQuadMesh(ptr)} })
}
