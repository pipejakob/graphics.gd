...
type Instance [1]gdclass.VisualShaderNodeTexture3DParameter
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeTexture3DParameter")
...
type Advanced = class
type class [1]gdclass.VisualShaderNodeTexture3DParameter

func (o class) AsObject() [1]gdreference.Object { return o[0].AsObject() }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeTexture3DParameter(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture3DParameter{gdclass.NewVisualShaderNodeTexture3DParameter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeTexture3DParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture3DParameter{gdclass.NewVisualShaderNodeTexture3DParameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVisualShaderNodeTexture3DParameter() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeTexture3DParameter() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeTexture3DParameter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeTexture3DParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTexture3DParameter(ptr)} })
}
