...
func (o class) AsRenderDataExtension() Advanced           { return Advanced(o) }
func (o Instance) AsRenderDataExtension() Instance        { return o }
func (o *Extension[T]) AsRenderDataExtension() Instance   { return o.Super() }
...
func init() {
	gdclass.Register("RenderDataExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewRenderDataExtension(ptr)} })
}
