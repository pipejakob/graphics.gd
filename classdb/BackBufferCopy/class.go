...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewBackBufferCopy(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.BackBufferCopy{gdclass.NewBackBufferCopy(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetBackBufferCopy(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.BackBufferCopy{gdclass.NewBackBufferCopy(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetCopyMode() CopyMode { //gd:BackBufferCopy.get_copy_mode
	var r_ret = jumponly.Call[CopyMode](gd.ObjectChecked(self.AsObject()), methods.get_copy_mode, gdextension.SizeInt, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
func (o class) AsBackBufferCopy() Advanced                { return Advanced(o) }
func (o Instance) AsBackBufferCopy() Instance             { return o }
func (o *Extension[T]) AsBackBufferCopy() Instance        { return o.Super() }
...
func init() {
	gdclass.Register("BackBufferCopy", func(ptr gdreference.Object) any { return Instance{gdclass.NewBackBufferCopy(ptr)} })
}
