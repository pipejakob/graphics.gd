...
[CapsuleMesh]: https://pkg.go.dev/graphics.gd/classdb/CapsuleMesh
[CylinderMesh]: https://pkg.go.dev/graphics.gd/classdb/CylinderMesh
[Material]: https://pkg.go.dev/graphics.gd/classdb/Material
[PlaneMesh]: https://pkg.go.dev/graphics.gd/classdb/PlaneMesh
[PrismMesh]: https://pkg.go.dev/graphics.gd/classdb/PrismMesh
[SphereMesh]: https://pkg.go.dev/graphics.gd/classdb/SphereMesh
*/
...
func (self class) GetAddUv2() bool { //gd:PrimitiveMesh.get_add_uv2
	var r_ret = jumponly.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_add_uv2, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetUv2Padding() float64 { //gd:PrimitiveMesh.get_uv2_padding
	var r_ret = jumponly.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_uv2_padding, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func init() {
	gdclass.Register("PrimitiveMesh", func(ptr gdreference.Object) any { return Instance{gdclass.NewPrimitiveMesh(ptr)} })
}
