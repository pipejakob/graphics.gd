...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("PlaceholderTexture2D")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewPlaceholderTexture2D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PlaceholderTexture2D{gdclass.NewPlaceholderTexture2D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetPlaceholderTexture2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.PlaceholderTexture2D{gdclass.NewPlaceholderTexture2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsPlaceholderTexture2D() Advanced         { return Advanced(o) }
func (o Instance) AsPlaceholderTexture2D() Instance      { return o }
func (o *Extension[T]) AsPlaceholderTexture2D() Instance { return o.Super() }
...
func init() {
	gdclass.Register("PlaceholderTexture2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewPlaceholderTexture2D(ptr)} })
}
