...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVec4Parameter{gdclass.NewVisualShaderNodeVec4Parameter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeVec4Parameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec4Parameter{gdclass.NewVisualShaderNodeVec4Parameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetDefaultValue() Vector4.XYZW { //gd:VisualShaderNodeVec4Parameter.get_default_value
	var r_ret = jumponly.Call[Vector4.XYZW](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeVector4, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
...
func init() {
	gdclass.Register("VisualShaderNodeVec4Parameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec4Parameter(ptr)} })
}
