...
[RichTextLabel.InstallEffect]: https://pkg.go.dev/graphics.gd/classdb/RichTextLabel#Instance.InstallEffect
*/
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("RichTextEffect")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewRichTextEffect(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RichTextEffect{gdclass.NewRichTextEffect(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetRichTextEffect(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RichTextEffect{gdclass.NewRichTextEffect(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsRichTextEffect() Advanced            { return Advanced(o) }
func (o Instance) AsRichTextEffect() Instance         { return o }
func (o *Extension[T]) AsRichTextEffect() Instance    { return o.Super() }
...
func init() {
	gdclass.Register("RichTextEffect", func(ptr gdreference.Object) any { return Instance{gdclass.NewRichTextEffect(ptr)} })
}
