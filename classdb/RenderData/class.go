...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RenderData{gdclass.NewRenderData(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetRenderData(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RenderData{gdclass.NewRenderData(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetRenderSceneBuffers() [1]gdclass.RenderSceneBuffers { //gd:RenderData.get_render_scene_buffers
	...
	var ret = [1]gdclass.RenderSceneBuffers{gdclass.NewRenderSceneBuffers(gd.PointerWithOwnershipTransferredToGo(r_ret))}
	return ret
}
func (self class) GetRenderSceneData() [1]gdclass.RenderSceneData { //gd:RenderData.get_render_scene_data
	...
	var ret = [1]gdclass.RenderSceneData{gdclass.NewRenderSceneData(gdreference.LetObject(r_ret))}
	return ret
}
...
func init() {
	gdclass.Register("RenderData", func(ptr gdreference.Object) any { return Instance{gdclass.NewRenderData(ptr)} })
}
