...
func (o class) AsEditorDock() EditorDock.Advanced         { return EditorDock.Advanced{gdclass.NewEditorDock(o[0].AsObject()[0])} }
func (o *Extension[T]) AsEditorDock() EditorDock.Instance { return o.Super().AsEditorDock() }
func (o Instance) AsEditorDock() EditorDock.Instance      { return EditorDock.Instance{gdclass.NewEditorDock(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("FileSystemDock", func(ptr gdreference.Object) any { return Instance{gdclass.NewFileSystemDock(ptr)} })
}
