...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ResourceImporterShaderFile")
...
type Advanced = class
type class [1]gdclass.ResourceImporterShaderFile

func (o class) AsObject() [1]gdreference.Object { return o[0].AsObject() }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewResourceImporterShaderFile(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterShaderFile{gdclass.NewResourceImporterShaderFile(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetResourceImporterShaderFile(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (o class) AsResourceImporterShaderFile() Advanced         { return Advanced(o) }
func (o Instance) AsResourceImporterShaderFile() Instance      { return o }
func (o *Extension[T]) AsResourceImporterShaderFile() Instance { return o.Super() }
...
func init() {
	gdclass.Register("ResourceImporterShaderFile", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceImporterShaderFile(ptr)} })
}
