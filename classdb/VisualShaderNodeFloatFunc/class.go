...
[Function]: https://pkg.go.dev/graphics.gd/classdb/VisualShaderNodeFloatFunc#Instance.Function
*/
...
func init() {
	gdclass.Register("VisualShaderNodeFloatFunc", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeFloatFunc(ptr)} })
}
