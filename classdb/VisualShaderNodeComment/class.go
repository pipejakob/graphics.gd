...
func (o class) AsVisualShaderNodeFrame() VisualShaderNodeFrame.Advanced {
	return VisualShaderNodeFrame.Advanced{gdclass.NewVisualShaderNodeFrame(o[0].AsObject()[0])}
}
func (o *Extension[T]) AsVisualShaderNodeFrame() VisualShaderNodeFrame.Instance {
	return o.Super().AsVisualShaderNodeFrame()
}
func (o Instance) AsVisualShaderNodeFrame() VisualShaderNodeFrame.Instance {
	return VisualShaderNodeFrame.Instance{gdclass.NewVisualShaderNodeFrame(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeComment", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeComment(ptr)} })
}
