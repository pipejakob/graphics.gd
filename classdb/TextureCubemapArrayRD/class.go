...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("TextureCubemapArrayRD")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewTextureCubemapArrayRD(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.TextureCubemapArrayRD{gdclass.NewTextureCubemapArrayRD(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetTextureCubemapArrayRD(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.TextureCubemapArrayRD{gdclass.NewTextureCubemapArrayRD(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsTextureCubemapArrayRD() Advanced         { return Advanced(o) }
func (o Instance) AsTextureCubemapArrayRD() Instance      { return o }
func (o *Extension[T]) AsTextureCubemapArrayRD() Instance { return o.Super() }
func (o class) AsTextureLayeredRD() TextureLayeredRD.Advanced {
	return TextureLayeredRD.Advanced{gdclass.NewTextureLayeredRD(o[0].AsObject()[0])}
}
func (o *Extension[T]) AsTextureLayeredRD() TextureLayeredRD.Instance {
	return o.Super().AsTextureLayeredRD()
}
func (o Instance) AsTextureLayeredRD() TextureLayeredRD.Instance {
	return TextureLayeredRD.Instance{gdclass.NewTextureLayeredRD(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("TextureCubemapArrayRD", func(ptr gdreference.Object) any { return Instance{gdclass.NewTextureCubemapArrayRD(ptr)} })
}
