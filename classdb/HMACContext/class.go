...
var methods struct {
	start  gdextension.MethodForClass `hash:"3537364598"`
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("HMACContext")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.HMACContext{gdclass.NewHMACContext(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetHMACContext(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.HMACContext{gdclass.NewHMACContext(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func init() {
	gdclass.Register("HMACContext", func(ptr gdreference.Object) any { return Instance{gdclass.NewHMACContext(ptr)} })
}
