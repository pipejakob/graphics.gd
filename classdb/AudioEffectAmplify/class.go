...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AudioEffectAmplify")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewAudioEffectAmplify(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectAmplify{gdclass.NewAudioEffectAmplify(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioEffectAmplify(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (self class) SetVolumeDb(volume float64) { //gd:AudioEffectAmplify.set_volume_db
	jumponly.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_volume_db, 0|(gdextension.SizeFloat<<4), &struct{ volume float64 }{volume})
}
...
func (o class) AsAudioEffectAmplify() Advanced              { return Advanced(o) }
func (o Instance) AsAudioEffectAmplify() Instance           { return o }
func (o *Extension[T]) AsAudioEffectAmplify() Instance      { return o.Super() }
...
func init() {
	gdclass.Register("AudioEffectAmplify", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectAmplify(ptr)} })
}
