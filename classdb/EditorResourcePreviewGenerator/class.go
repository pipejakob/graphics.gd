...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("EditorResourcePreviewGenerator")
...
type Interface interface {
	...
	Generate(resource Resource.Instance, size Vector2i.XY, metadata map[string]any) Texture2D.Instance
	...
	GenerateFromPath(path string, size Vector2i.XY, metadata map[string]any) Texture2D.Instance
...
[EditorResourceTooltipPlugin.MakeTooltipForPath]: https://pkg.go.dev/graphics.gd/classdb/EditorResourceTooltipPlugin#Instance.MakeTooltipForPath
*/
func (Instance) _generate(impl func(ptr gdclass.Receiver, resource Resource.Instance, size Vector2i.XY, metadata map[string]any) Texture2D.Instance) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
...
[Generate]: https://pkg.go.dev/graphics.gd/classdb/EditorResourcePreviewGenerator#Interface
*/
func (Instance) _generate_from_path(impl func(ptr gdclass.Receiver, path string, size Vector2i.XY, metadata map[string]any) Texture2D.Instance) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
...
func (o *Extension[T]) AsEditorResourcePreviewGenerator() Instance { return o.Super() }
...
func init() {
	gdclass.Register("EditorResourcePreviewGenerator", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorResourcePreviewGenerator(ptr)} })
}
