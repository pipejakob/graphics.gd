...
[RenderSceneBuffersRD]: https://pkg.go.dev/graphics.gd/classdb/RenderSceneBuffersRD
*/
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RenderSceneBuffers{gdclass.NewRenderSceneBuffers(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetRenderSceneBuffers(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RenderSceneBuffers{gdclass.NewRenderSceneBuffers(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o *Extension[T]) AsRenderSceneBuffers() Instance { return o.Super() }
...
func init() {
	gdclass.Register("RenderSceneBuffers", func(ptr gdreference.Object) any { return Instance{gdclass.NewRenderSceneBuffers(ptr)} })
}
