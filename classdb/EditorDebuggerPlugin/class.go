...
You can retrieve the available [EditorDebuggerSession]s via [GetSessions] or get a specific one via [GetSession].
...
[EditorPlugin.AddDebuggerPlugin]: https://pkg.go.dev/graphics.gd/classdb/EditorPlugin#Instance.AddDebuggerPlugin
...
[GetSessions]: https://pkg.go.dev/graphics.gd/classdb/EditorDebuggerPlugin#Instance.GetSessions
[SetupSession]: https://pkg.go.dev/graphics.gd/classdb/EditorDebuggerPlugin#Interface
*/
...
func (Instance) _has_capture(impl func(ptr gdclass.Receiver, capture string) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var capture = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
...
func (Instance) _capture(impl func(ptr gdclass.Receiver, message string, data []any, session_id int) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		...
		var data = Array.Through(gd.WrapArray[variant.Any](pointers.Pin(pointers.New[gd.Array](gd.UnsafeGet[gdextension.Array](p_args, 1)))))
...
func init() {
	gdclass.Register("EditorDebuggerPlugin", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorDebuggerPlugin(ptr)} })
}
