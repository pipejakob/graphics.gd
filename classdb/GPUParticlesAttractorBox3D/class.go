...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("GPUParticlesAttractorBox3D")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewGPUParticlesAttractorBox3D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GPUParticlesAttractorBox3D{gdclass.NewGPUParticlesAttractorBox3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetGPUParticlesAttractorBox3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractorBox3D{gdclass.NewGPUParticlesAttractorBox3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsGPUParticlesAttractorBox3D() Advanced         { return Advanced(o) }
func (o Instance) AsGPUParticlesAttractorBox3D() Instance      { return o }
func (o *Extension[T]) AsGPUParticlesAttractorBox3D() Instance { return o.Super() }
func (o class) AsGPUParticlesAttractor3D() GPUParticlesAttractor3D.Advanced {
	return GPUParticlesAttractor3D.Advanced{gdclass.NewGPUParticlesAttractor3D(o[0].AsObject()[0])}
}
...
func (o Instance) AsGPUParticlesAttractor3D() GPUParticlesAttractor3D.Instance {
	return GPUParticlesAttractor3D.Instance{gdclass.NewGPUParticlesAttractor3D(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("GPUParticlesAttractorBox3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewGPUParticlesAttractorBox3D(ptr)} })
}
