...
var methods struct {
	set_flags gdextension.MethodForClass `hash:"3960756792"`
	get_flags gdextension.MethodForClass `hash:"171277835"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeParticleEmit")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeParticleEmit(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleEmit{gdclass.NewVisualShaderNodeParticleEmit(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeParticleEmit(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleEmit{gdclass.NewVisualShaderNodeParticleEmit(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetFlags() EmitFlags { //gd:VisualShaderNodeParticleEmit.get_flags
	var r_ret = jumponly.Call[EmitFlags](gd.ObjectChecked(self.AsObject()), methods.get_flags, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeParticleEmit() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeParticleEmit() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeParticleEmit() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeParticleEmit", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleEmit(ptr)} })
}
