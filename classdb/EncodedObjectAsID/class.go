...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("EncodedObjectAsID")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EncodedObjectAsID{gdclass.NewEncodedObjectAsID(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
