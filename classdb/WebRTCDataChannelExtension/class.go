...
func (o class) AsWebRTCDataChannel() WebRTCDataChannel.Advanced {
	return WebRTCDataChannel.Advanced{gdclass.NewWebRTCDataChannel(o[0].AsObject()[0])}
}
...
func (o Instance) AsWebRTCDataChannel() WebRTCDataChannel.Instance {
	return WebRTCDataChannel.Instance{gdclass.NewWebRTCDataChannel(o[0].AsObject()[0])}
}
