...
var methods struct {
	set_window_id gdextension.MethodForClass `hash:"1286410249"`
	get_window_id gdextension.MethodForClass `hash:"3905245786"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("InputEventFromWindow")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewInputEventFromWindow(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InputEventFromWindow{gdclass.NewInputEventFromWindow(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetInputEventFromWindow(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.InputEventFromWindow{gdclass.NewInputEventFromWindow(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsInputEventFromWindow() Advanced          { return Advanced(o) }
func (o Instance) AsInputEventFromWindow() Instance       { return o }
func (o *Extension[T]) AsInputEventFromWindow() Instance  { return o.Super() }
...
func init() {
	gdclass.Register("InputEventFromWindow", func(ptr gdreference.Object) any { return Instance{gdclass.NewInputEventFromWindow(ptr)} })
}
