...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("SpringBoneCollisionSphere3D")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewSpringBoneCollisionSphere3D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SpringBoneCollisionSphere3D{gdclass.NewSpringBoneCollisionSphere3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetSpringBoneCollisionSphere3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SpringBoneCollisionSphere3D{gdclass.NewSpringBoneCollisionSphere3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsSpringBoneCollisionSphere3D() Advanced         { return Advanced(o) }
func (o Instance) AsSpringBoneCollisionSphere3D() Instance      { return o }
func (o *Extension[T]) AsSpringBoneCollisionSphere3D() Instance { return o.Super() }
...
func init() {
	gdclass.Register("SpringBoneCollisionSphere3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewSpringBoneCollisionSphere3D(ptr)} })
}
