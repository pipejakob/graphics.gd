...
[JacobianIK3D]: https://pkg.go.dev/graphics.gd/classdb/JacobianIK3D
*/
package JacobianIK3D
...
type Instance [1]gdclass.JacobianIK3D
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("JacobianIK3D")
...
type Any interface {
	gd.IsClass
	AsJacobianIK3D() Instance
}

// Advanced exposes a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type Advanced = class
type class [1]gdclass.JacobianIK3D

func (o class) AsObject() [1]gdreference.Object { return o[0].AsObject() }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewJacobianIK3D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.JacobianIK3D{gdclass.NewJacobianIK3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetJacobianIK3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.JacobianIK3D{gdclass.NewJacobianIK3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsJacobianIK3D() Advanced                      { return Advanced(o) }
func (o Instance) AsJacobianIK3D() Instance                   { return o }
func (o *Extension[T]) AsJacobianIK3D() Instance              { return o.Super() }
func (o class) AsIterateIK3D() IterateIK3D.Advanced           { return IterateIK3D.Advanced{gdclass.NewIterateIK3D(o[0].AsObject()[0])} }
func (o *Extension[T]) AsIterateIK3D() IterateIK3D.Instance   { return o.Super().AsIterateIK3D() }
func (o Instance) AsIterateIK3D() IterateIK3D.Instance        { return IterateIK3D.Instance{gdclass.NewIterateIK3D(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("JacobianIK3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewJacobianIK3D(ptr)} })
}
