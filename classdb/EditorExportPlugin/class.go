...
Register a [EditorExportPlugin] by creating a new [EditorPlugin] and calling its [EditorPlugin.AddExportPlugin] method.
...
type Interface interface {
	...
	EndGenerateAppleEmbeddedProject(path string, will_build_archive bool)
	...
	// Implementing this method is required if [BeginCustomizeResources] returns true.
	//
	// Note: [CustomizeResource] and [CustomizeScene] will not be called when the [EditorExportPlugin] script is modified unless this hash changes too.
	//
	// [BeginCustomizeResources]: https://pkg.go.dev/graphics.gd/classdb/EditorExportPlugin#Interface
	// [CustomizeResource]: https://pkg.go.dev/graphics.gd/classdb/EditorExportPlugin#Interface
	// [CustomizeScene]: https://pkg.go.dev/graphics.gd/classdb/EditorExportPlugin#Interface
...
func (self implementation) EndGenerateAppleEmbeddedProject(path string, will_build_archive bool) {
}
...
func (Instance) _export_file(impl func(ptr gdclass.Receiver, path string, atype string, features []string)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		...
		var atype = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 1)))))
...
func (Instance) _export_begin(impl func(ptr gdclass.Receiver, features []string, is_debug bool, path string, flags int)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var features = Packed.Strings(Array.Through(gd.WrapPackedStrings(pointers.Let[gd.PackedStringArray](gd.UnsafeGet[gd.PackedPointers](p_args, 0)))))
		defer pointers.End(gd.InternalPackedStrings(features))
...
Note: Only supported on iOS and visionOS.
*/
func (Instance) _end_generate_apple_embedded_project(impl func(ptr gdclass.Receiver, path string, will_build_archive bool)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var path = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
		defer pointers.End(gd.InternalString(path))
...
func (class) _end_generate_apple_embedded_project(impl func(ptr gdclass.Receiver, path String.Readable, will_build_archive bool)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var path = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
		defer pointers.End(gd.InternalString(path))
		var will_build_archive = gd.UnsafeGet[bool](p_args, 1)
...
func (self class) Virtual(name string) reflect.Value {
	...
	case "_end_generate_apple_embedded_project":
		return reflect.ValueOf(self._end_generate_apple_embedded_project)
