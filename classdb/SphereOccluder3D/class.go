...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SphereOccluder3D{gdclass.NewSphereOccluder3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetSphereOccluder3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SphereOccluder3D{gdclass.NewSphereOccluder3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsOccluder3D() Occluder3D.Advanced         { return Occluder3D.Advanced{gdclass.NewOccluder3D(o[0].AsObject()[0])} }
func (o *Extension[T]) AsOccluder3D() Occluder3D.Instance { return o.Super().AsOccluder3D() }
func (o Instance) AsOccluder3D() Occluder3D.Instance      { return Occluder3D.Instance{gdclass.NewOccluder3D(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("SphereOccluder3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewSphereOccluder3D(ptr)} })
}
