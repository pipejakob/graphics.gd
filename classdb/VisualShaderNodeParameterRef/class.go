...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeParameterRef")
...
type Advanced = class
type class [1]gdclass.VisualShaderNodeParameterRef

func (o class) AsObject() [1]gdreference.Object { return o[0].AsObject() }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeParameterRef(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParameterRef{gdclass.NewVisualShaderNodeParameterRef(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeParameterRef(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParameterRef{gdclass.NewVisualShaderNodeParameterRef(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsVisualShaderNodeParameterRef() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeParameterRef() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeParameterRef() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeParameterRef", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParameterRef(ptr)} })
}
