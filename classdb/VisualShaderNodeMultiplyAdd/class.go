...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeMultiplyAdd(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeMultiplyAdd{gdclass.NewVisualShaderNodeMultiplyAdd(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeMultiplyAdd(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeMultiplyAdd{gdclass.NewVisualShaderNodeMultiplyAdd(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) OpType() OpType { //gd:VisualShaderNodeMultiplyAdd.op_type
...
func (self Instance) SetOpType(value OpType) Instance { //gd:VisualShaderNodeMultiplyAdd.op_type
...
func (o class) AsVisualShaderNodeMultiplyAdd() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeMultiplyAdd() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeMultiplyAdd() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeMultiplyAdd", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeMultiplyAdd(ptr)} })
}
