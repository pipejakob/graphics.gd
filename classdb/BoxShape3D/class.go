...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewBoxShape3D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.BoxShape3D{gdclass.NewBoxShape3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetBoxShape3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.BoxShape3D{gdclass.NewBoxShape3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) Size() Vector3.XYZ { //gd:BoxShape3D.size
	return Vector3.XYZ(class(self).GetSize())
}

// SetSize sets the property returned by [GetSize]. Returns the instance, so that property settings can be chained.
func (self Instance) SetSize(value Vector3.XYZ) Instance { //gd:BoxShape3D.size
...
func (o class) AsBoxShape3D() Advanced                { return Advanced(o) }
func (o Instance) AsBoxShape3D() Instance             { return o }
func (o *Extension[T]) AsBoxShape3D() Instance        { return o.Super() }
...
func init() {
	gdclass.Register("BoxShape3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewBoxShape3D(ptr)} })
}
