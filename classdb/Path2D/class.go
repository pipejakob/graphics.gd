...
var methods struct {
	set_curve gdextension.MethodForClass `hash:"659985499"`
	get_curve gdextension.MethodForClass `hash:"660369445"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("Path2D")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewPath2D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Path2D{gdclass.NewPath2D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetPath2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Path2D{gdclass.NewPath2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) SetCurve(curve [1]gdclass.Curve2D) { //gd:Path2D.set_curve
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_curve, 0|(gdextension.SizeObject<<4), &struct{ curve gdextension.Object }{gdextension.Object(gdreference.GetObject(gdclass.GetCurve2D(curve[0])[0]))})
...
func (self class) GetCurve() [1]gdclass.Curve2D { //gd:Path2D.get_curve
	...
	runtime.KeepAlive(self[0].Anchor())
	var ret = [1]gdclass.Curve2D{gdclass.NewCurve2D(gd.PointerWithOwnershipTransferredToGo(r_ret))}
	return ret
}
func (o class) AsPath2D() Advanced                        { return Advanced(o) }
func (o Instance) AsPath2D() Instance                     { return o }
func (o *Extension[T]) AsPath2D() Instance                { return o.Super() }
...
func init() {
	gdclass.Register("Path2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewPath2D(ptr)} })
}
