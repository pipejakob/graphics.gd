...
[Echo]: https://pkg.go.dev/graphics.gd/classdb/InputEventKey#Instance.Echo
...
[Unicode]: https://pkg.go.dev/graphics.gd/classdb/InputEventKey#Instance.Unicode
*/
...
func init() {
	gdclass.Register("InputEventKey", func(ptr gdreference.Object) any { return Instance{gdclass.NewInputEventKey(ptr)} })
}
