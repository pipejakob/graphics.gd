...
type Instance [1]gdclass.VisualShaderNodeTransformDecompose
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeTransformDecompose")
...
type Any interface {
	gd.IsClass
	AsVisualShaderNodeTransformDecompose() Instance
}

// Advanced exposes a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type Advanced = class
type class [1]gdclass.VisualShaderNodeTransformDecompose

func (o class) AsObject() [1]gdreference.Object { return *(*[1]gdreference.Object)(ie.As(&o)) }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeTransformDecompose(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTransformDecompose{gdclass.NewVisualShaderNodeTransformDecompose(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeTransformDecompose(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformDecompose{gdclass.NewVisualShaderNodeTransformDecompose(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVisualShaderNodeTransformDecompose() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeTransformDecompose() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeTransformDecompose() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeTransformDecompose", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTransformDecompose(ptr)} })
}
