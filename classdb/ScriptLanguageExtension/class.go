...
func (Instance) _is_control_flow_keyword(impl func(ptr gdclass.Receiver, keyword string) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var keyword = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
...
func (Instance) _make_template(impl func(ptr gdclass.Receiver, template string, class_name string, base_class_name string) Script.Instance) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var template = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
		defer pointers.End(gd.InternalString(template))
		var class_name = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 1)))))
		defer pointers.End(gd.InternalString(class_name))
		var base_class_name = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 2)))))
...
func (Instance) _validate(impl func(ptr gdclass.Receiver, script string, path string, validate_functions bool, validate_errors bool, validate_warnings bool, validate_safe_lines bool) Validation) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var script = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
...
func (Instance) _find_function(impl func(ptr gdclass.Receiver, function string, code string) int) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var function = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
		defer pointers.End(gd.InternalString(function))
		var code = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 1)))))
...
func (Instance) _make_function(impl func(ptr gdclass.Receiver, class_name string, function_name string, function_args []string) string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var class_name = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
		defer pointers.End(gd.InternalString(class_name))
		var function_name = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 1)))))
		defer pointers.End(gd.InternalString(function_name))
		var function_args = Packed.Strings(Array.Through(gd.WrapPackedStrings(pointers.Let[gd.PackedStringArray](gd.UnsafeGet[gd.PackedPointers](p_args, 2)))))
...
func (Instance) _lookup_code(impl func(ptr gdclass.Receiver, code string, symbol string, path string, owner Object.Instance) Code) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var code = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
		defer pointers.End(gd.InternalString(code))
		var symbol = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 1)))))
...
func (Instance) _debug_parse_stack_level_expression(impl func(ptr gdclass.Receiver, level int, expression string, max_subitems int, max_depth int) string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var level = gd.UnsafeGet[int64](p_args, 0)
		var expression = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 1)))))
...
func (Instance) _reload_scripts(impl func(ptr gdclass.Receiver, scripts []Script.Instance, soft_reload bool)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var scripts = Array.Through(gd.WrapArray[variant.Any](pointers.Pin(pointers.New[gd.Array](gd.UnsafeGet[gdextension.Array](p_args, 0)))))
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScriptLanguageExtension{gdclass.NewScriptLanguageExtension(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsScriptLanguage() ScriptLanguage.Advanced {
	return ScriptLanguage.Advanced{gdclass.NewScriptLanguage(o[0].AsObject()[0])}
}
...
func (o Instance) AsScriptLanguage() ScriptLanguage.Instance {
	return ScriptLanguage.Instance{gdclass.NewScriptLanguage(o[0].AsObject()[0])}
}
