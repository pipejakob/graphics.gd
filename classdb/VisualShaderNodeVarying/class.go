...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVarying{gdclass.NewVisualShaderNodeVarying(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeVarying(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVarying{gdclass.NewVisualShaderNodeVarying(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsVisualShaderNodeVarying() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeVarying() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeVarying() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeVarying", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVarying(ptr)} })
}
