...
var methods struct {
	set_pan gdextension.MethodForClass `hash:"373806689"`
	get_pan gdextension.MethodForClass `hash:"1740695150"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AudioEffectPanner")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewAudioEffectPanner(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectPanner{gdclass.NewAudioEffectPanner(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioEffectPanner(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectPanner{gdclass.NewAudioEffectPanner(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) SetPan(cpanume float64) { //gd:AudioEffectPanner.set_pan
	jumponly.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_pan, 0|(gdextension.SizeFloat<<4), &struct{ cpanume float64 }{cpanume})
}
func (self class) GetPan() float64 { //gd:AudioEffectPanner.get_pan
	var r_ret = jumponly.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_pan, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
func (o class) AsAudioEffectPanner() Advanced               { return Advanced(o) }
func (o Instance) AsAudioEffectPanner() Instance            { return o }
func (o *Extension[T]) AsAudioEffectPanner() Instance       { return o.Super() }
...
func init() {
	gdclass.Register("AudioEffectPanner", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectPanner(ptr)} })
}
