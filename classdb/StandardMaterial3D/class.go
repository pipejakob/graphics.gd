...
func (o class) AsBaseMaterial3D() BaseMaterial3D.Advanced {
	return BaseMaterial3D.Advanced{gdclass.NewBaseMaterial3D(o[0].AsObject()[0])}
}
func (o *Extension[T]) AsBaseMaterial3D() BaseMaterial3D.Instance {
	return o.Super().AsBaseMaterial3D()
}
func (o Instance) AsBaseMaterial3D() BaseMaterial3D.Instance {
	return BaseMaterial3D.Instance{gdclass.NewBaseMaterial3D(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("StandardMaterial3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewStandardMaterial3D(ptr)} })
}
