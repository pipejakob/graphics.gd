...
[SkeletonModificationStack2D.ModificationCount]: https://pkg.go.dev/graphics.gd/classdb/SkeletonModificationStack2D#Instance.ModificationCount
*/
package Skeleton2D
...
func (self class) SetModificationStack(modification_stack [1]gdclass.SkeletonModificationStack2D) { //gd:Skeleton2D.set_modification_stack
	...
	runtime.KeepAlive(self[0].Anchor())
	runtime.KeepAlive(modification_stack[0].Anchor())
}
...
func (self class) BoneSetupChanged() Signal.Any {
	return Signal.Via(gd.WrapSignal(gd.NewSignalOf(self.AsObject(), gd.NewStringName(`bone_setup_changed`))))
}
...
func init() {
	gdclass.Register("Skeleton2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewSkeleton2D(ptr)} })
}
