...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ViewportTexture{gdclass.NewViewportTexture(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetViewportTexture(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ViewportTexture{gdclass.NewViewportTexture(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsViewportTexture() Advanced             { return Advanced(o) }
func (o Instance) AsViewportTexture() Instance          { return o }
func (o *Extension[T]) AsViewportTexture() Instance     { return o.Super() }
...
func init() {
	gdclass.Register("ViewportTexture", func(ptr gdreference.Object) any { return Instance{gdclass.NewViewportTexture(ptr)} })
}
