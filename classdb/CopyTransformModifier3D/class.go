...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CopyTransformModifier3D{gdclass.NewCopyTransformModifier3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetCopyTransformModifier3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CopyTransformModifier3D{gdclass.NewCopyTransformModifier3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsCopyTransformModifier3D() Advanced         { return Advanced(o) }
...
func init() {
	gdclass.Register("CopyTransformModifier3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCopyTransformModifier3D(ptr)} })
}
