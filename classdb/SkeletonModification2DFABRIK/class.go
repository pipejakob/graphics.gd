...
[SkeletonModification2DCCDIK]: https://pkg.go.dev/graphics.gd/classdb/SkeletonModification2DCCDIK
*/
...
func init() {
	gdclass.Register("SkeletonModification2DFABRIK", func(ptr gdreference.Object) any { return Instance{gdclass.NewSkeletonModification2DFABRIK(ptr)} })
}
