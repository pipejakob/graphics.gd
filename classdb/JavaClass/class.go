...
/*
Returns the object's Java methods and their signatures as an slice of dictionaries, in the same format as [Object.GetMethodList].

[Object.GetMethodList]: https://pkg.go.dev/graphics.gd/variant/Object#GetMethodList
*/
func (self Instance) GetJavaMethodList() []Object.PropertyInfo { //gd:JavaClass.get_java_method_list
	return []Object.PropertyInfo(gd.ArrayAs[[]Object.PropertyInfo](gd.InternalArray(Advanced(self).GetJavaMethodList())))
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.JavaClass{gdclass.NewJavaClass(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetJavaClass(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.JavaClass{gdclass.NewJavaClass(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsJavaClass() Advanced         { return Advanced(o) }
func (o Instance) AsJavaClass() Instance      { return o }
func (o *Extension[T]) AsJavaClass() Instance { return o.Super() }
...
func init() {
	gdclass.Register("JavaClass", func(ptr gdreference.Object) any { return Instance{gdclass.NewJavaClass(ptr)} })
}
