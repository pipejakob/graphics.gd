...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("HSlider")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewHSlider(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.HSlider{gdclass.NewHSlider(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetHSlider(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.HSlider{gdclass.NewHSlider(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsHSlider() Advanced                       { return Advanced(o) }
func (o Instance) AsHSlider() Instance                    { return o }
func (o *Extension[T]) AsHSlider() Instance               { return o.Super() }
func (o class) AsSlider() Slider.Advanced                 { return Slider.Advanced{gdclass.NewSlider(o[0].AsObject()[0])} }
func (o *Extension[T]) AsSlider() Slider.Instance         { return o.Super().AsSlider() }
func (o Instance) AsSlider() Slider.Instance              { return Slider.Instance{gdclass.NewSlider(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("HSlider", func(ptr gdreference.Object) any { return Instance{gdclass.NewHSlider(ptr)} })
}
