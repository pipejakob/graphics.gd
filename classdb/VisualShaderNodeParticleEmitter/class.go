...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeParticleEmitter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleEmitter{gdclass.NewVisualShaderNodeParticleEmitter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
