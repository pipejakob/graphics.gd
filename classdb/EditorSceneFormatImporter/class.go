...
To use [EditorSceneFormatImporter], register it using the [EditorPlugin.AddSceneFormatImporterPlugin] method first.

[EditorPlugin.AddSceneFormatImporterPlugin]: https://pkg.go.dev/graphics.gd/classdb/EditorPlugin#Instance.AddSceneFormatImporterPlugin
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("EditorSceneFormatImporter")
...
type MoreArgs [1]gdclass.EditorSceneFormatImporter
...
[GetImportOptions]: https://pkg.go.dev/graphics.gd/classdb/EditorSceneFormatImporter#Interface
*/
func (self MoreArgs) AddImportOptionAdvanced(atype variant.Type, name string, default_value any, hint ClassDB.PropertyHint, hint_string string, usage_flags Flags) { //gd:EditorSceneFormatImporter.add_import_option_advanced
	...
	if !gd.Linked {
		...
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				...
				gdreference.SetObject(gdclass.GetEditorSceneFormatImporter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (o class) AsEditorSceneFormatImporter() Advanced         { return Advanced(o) }
func (o Instance) AsEditorSceneFormatImporter() Instance      { return o }
func (o *Extension[T]) AsEditorSceneFormatImporter() Instance { return o.Super() }
