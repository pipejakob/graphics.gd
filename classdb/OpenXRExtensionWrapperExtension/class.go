...
/*
[OpenXRExtensionWrapperExtension] allows implementing OpenXR extensions with GDExtension. The extension should be registered with [OpenXRExtensionWrapper.RegisterExtensionWrapper].

[OpenXRExtensionWrapper.RegisterExtensionWrapper]: https://pkg.go.dev/graphics.gd/classdb/OpenXRExtensionWrapper#Instance.RegisterExtensionWrapper
[OpenXRExtensionWrapperExtension]: https://pkg.go.dev/graphics.gd/classdb/OpenXRExtensionWrapperExtension
*/
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRExtensionWrapperExtension{gdclass.NewOpenXRExtensionWrapperExtension(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetOpenXRExtensionWrapperExtension(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRExtensionWrapperExtension{gdclass.NewOpenXRExtensionWrapperExtension(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func init() {
	gdclass.Register("OpenXRExtensionWrapperExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRExtensionWrapperExtension(ptr)} })
}
