...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("CSGCombiner3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CSGCombiner3D{gdclass.NewCSGCombiner3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
