...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesCollisionSphere3D{gdclass.NewGPUParticlesCollisionSphere3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
