...
[Columns]: https://pkg.go.dev/graphics.gd/classdb/GridContainer#Instance.Columns
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("GridContainer")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewGridContainer(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GridContainer{gdclass.NewGridContainer(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetGridContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.GridContainer{gdclass.NewGridContainer(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetColumns() int64 { //gd:GridContainer.get_columns
	var r_ret = jumponly.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_columns, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
func (o class) AsGridContainer() Advanced                 { return Advanced(o) }
func (o Instance) AsGridContainer() Instance              { return o }
func (o *Extension[T]) AsGridContainer() Instance         { return o.Super() }
...
func init() {
	gdclass.Register("GridContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewGridContainer(ptr)} })
}
