...
func (Instance) _get_code(impl func(ptr gdclass.Receiver, input_vars []string, output_vars []string, mode Shader.Mode, atype VisualShader.Type) string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var input_vars = Array.Through(gd.WrapArray[String.Readable](pointers.Pin(pointers.New[gd.Array](gd.UnsafeGet[gdextension.Array](p_args, 0)))))
		defer pointers.End(gd.InternalArray(input_vars))
		var output_vars = Array.Through(gd.WrapArray[String.Readable](pointers.Pin(pointers.New[gd.Array](gd.UnsafeGet[gdextension.Array](p_args, 1)))))
...
func init() {
	gdclass.Register("VisualShaderNodeCustom", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeCustom(ptr)} })
}
