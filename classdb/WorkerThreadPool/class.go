...
func (self class) AddTask(action Callable.Function, high_priority bool, description String.Readable) int64 { //gd:WorkerThreadPool.add_task
	once.Do(singleton)
	var r_ret = noescape.CallThreadSafe[int64](gdreference.GetObject(self.AsObject()[0]), methods.add_task, gdextension.SizeInt|(gdextension.SizeCallable<<4)|(gdextension.SizeBool<<8)|(gdextension.SizeString<<12), &struct {
...
func (self class) IsTaskCompleted(task_id int64) bool { //gd:WorkerThreadPool.is_task_completed
	once.Do(singleton)
	var r_ret = noescape.CallThreadSafe[bool](gdreference.GetObject(self.AsObject()[0]), methods.is_task_completed, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ task_id int64 }{task_id})
	var ret = r_ret
	return ret
}
func (self class) WaitForTaskCompletion(task_id int64) Error.Code { //gd:WorkerThreadPool.wait_for_task_completion
	once.Do(singleton)
	var r_ret = noescape.CallThreadSafe[int64](gdreference.GetObject(self.AsObject()[0]), methods.wait_for_task_completion, gdextension.SizeInt|(gdextension.SizeInt<<4), &struct{ task_id int64 }{task_id})
	var ret = Error.Code(r_ret)
	return ret
}
func (self class) GetCallerTaskId() int64 { //gd:WorkerThreadPool.get_caller_task_id
	once.Do(singleton)
	var r_ret = noescape.CallThreadSafe[int64](gdreference.GetObject(self.AsObject()[0]), methods.get_caller_task_id, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AddGroupTask(action Callable.Function, elements int64, tasks_needed int64, high_priority bool, description String.Readable) int64 { //gd:WorkerThreadPool.add_group_task
	once.Do(singleton)
	var r_ret = noescape.CallThreadSafe[int64](gdreference.GetObject(self.AsObject()[0]), methods.add_group_task, gdextension.SizeInt|(gdextension.SizeCallable<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeBool<<16)|(gdextension.SizeString<<20), &struct {
		action        gdextension.Callable
		elements      int64
		tasks_needed  int64
		high_priority bool
...
func (self class) IsGroupTaskCompleted(group_id int64) bool { //gd:WorkerThreadPool.is_group_task_completed
	once.Do(singleton)
	var r_ret = noescape.CallThreadSafe[bool](gdreference.GetObject(self.AsObject()[0]), methods.is_group_task_completed, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ group_id int64 }{group_id})
	var ret = r_ret
	return ret
}
func (self class) GetGroupProcessedElementCount(group_id int64) int64 { //gd:WorkerThreadPool.get_group_processed_element_count
	once.Do(singleton)
	var r_ret = noescape.CallThreadSafe[int64](gdreference.GetObject(self.AsObject()[0]), methods.get_group_processed_element_count, gdextension.SizeInt|(gdextension.SizeInt<<4), &struct{ group_id int64 }{group_id})
	var ret = r_ret
	return ret
}
func (self class) WaitForGroupTaskCompletion(group_id int64) { //gd:WorkerThreadPool.wait_for_group_task_completion
	once.Do(singleton)
	noescape.CallThreadSafe[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.wait_for_group_task_completion, 0|(gdextension.SizeInt<<4), &struct{ group_id int64 }{group_id})
}
func (self class) GetCallerGroupId() int64 { //gd:WorkerThreadPool.get_caller_group_id
	once.Do(singleton)
	var r_ret = noescape.CallThreadSafe[int64](gdreference.GetObject(self.AsObject()[0]), methods.get_caller_group_id, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func init() {
	gdclass.Register("WorkerThreadPool", func(ptr gdreference.Object) any { return Instance{gdclass.NewWorkerThreadPool(ptr)} })
}
