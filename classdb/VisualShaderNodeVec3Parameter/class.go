...
type Instance [1]gdclass.VisualShaderNodeVec3Parameter
...
var methods struct {
	...
	set_default_value         gdextension.MethodForClass `hash:"3460891852"`
	get_default_value         gdextension.MethodForClass `hash:"3360562783"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeVec3Parameter")
...
type Any interface {
	gd.IsClass
	AsVisualShaderNodeVec3Parameter() Instance
}

// Advanced exposes a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type Advanced = class
type class [1]gdclass.VisualShaderNodeVec3Parameter

func (o class) AsObject() [1]gdreference.Object { return *(*[1]gdreference.Object)(ie.As(&o)) }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeVec3Parameter(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVec3Parameter{gdclass.NewVisualShaderNodeVec3Parameter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeVec3Parameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Parameter{gdclass.NewVisualShaderNodeVec3Parameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) SetDefaultValue(value Vector3.XYZ) { //gd:VisualShaderNodeVec3Parameter.set_default_value
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_default_value, 0|(gdextension.SizeVector3<<4), &struct{ value Vector3.XYZ }{value})
	runtime.KeepAlive(self[0].Anchor())
}
func (self class) GetDefaultValue() Vector3.XYZ { //gd:VisualShaderNodeVec3Parameter.get_default_value
	var r_ret = jumponly.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeVector3, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeVec3Parameter() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeVec3Parameter() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeVec3Parameter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeVec3Parameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec3Parameter(ptr)} })
}
