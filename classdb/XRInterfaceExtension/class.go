...
type Interface interface {
	...
	GetViewCount() int
	// Returns the [Transform3D.BasisOrigin] that positions the [XRCamera3D] in the world.
	//
	...
	// Returns the format of the texture returned by [GetVrsTexture].
	//
	// [GetVrsTexture]: https://pkg.go.dev/graphics.gd/classdb/XRInterfaceExtension#Interface
	GetVrsTextureFormat() XRInterface.VRSTextureFormat
	// Called if this [XRInterfaceExtension] is active before our physics and game process is called. Most XR interfaces will update its [XRPositionalTracker]s at this point in time.
	//
	// [XRInterfaceExtension]: https://pkg.go.dev/graphics.gd/classdb/XRInterfaceExtension
...
func (Instance) _get_suggested_pose_names(impl func(ptr gdclass.Receiver, tracker_name string) []string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var tracker_name = String.Name(String.Via(gd.WrapStringName(pointers.Pin(pointers.New[gd.StringName](gd.UnsafeGet[gdextension.StringName](p_args, 0))))))
...
func (Instance) _trigger_haptic_pulse(impl func(ptr gdclass.Receiver, action_name string, tracker_name string, frequency Float.X, amplitude Float.X, duration_sec Float.X, delay_sec Float.X)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var action_name = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 0)))))
		defer pointers.End(gd.InternalString(action_name))
		var tracker_name = String.Name(String.Via(gd.WrapStringName(pointers.Pin(pointers.New[gd.StringName](gd.UnsafeGet[gdextension.StringName](p_args, 1))))))
		defer pointers.End(gd.InternalStringName(tracker_name))
...
func init() {
	gdclass.Register("XRInterfaceExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewXRInterfaceExtension(ptr)} })
}
