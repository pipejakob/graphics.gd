...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewCubemapArray(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CubemapArray{gdclass.NewCubemapArray(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetCubemapArray(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CubemapArray{gdclass.NewCubemapArray(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsCubemapArray() Advanced         { return Advanced(o) }
func (o Instance) AsCubemapArray() Instance      { return o }
func (o *Extension[T]) AsCubemapArray() Instance { return o.Super() }
func (o class) AsImageTextureLayered() ImageTextureLayered.Advanced {
	return ImageTextureLayered.Advanced{gdclass.NewImageTextureLayered(o[0].AsObject()[0])}
}
...
func (o Instance) AsImageTextureLayered() ImageTextureLayered.Instance {
	return ImageTextureLayered.Instance{gdclass.NewImageTextureLayered(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("CubemapArray", func(ptr gdreference.Object) any { return Instance{gdclass.NewCubemapArray(ptr)} })
}
