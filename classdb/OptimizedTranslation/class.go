...
This class does not store the untranslated strings for optimization purposes. Therefore, [Translation.GetMessageList] always returns an empty array, and [Translation.GetMessageCount] always returns 0.

[Translation.GetMessageCount]: https://pkg.go.dev/graphics.gd/classdb/Translation#Instance.GetMessageCount
[Translation.GetMessageList]: https://pkg.go.dev/graphics.gd/classdb/Translation#Instance.GetMessageList
*/
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewOptimizedTranslation(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OptimizedTranslation{gdclass.NewOptimizedTranslation(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetOptimizedTranslation(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (o *Extension[T]) AsOptimizedTranslation() Instance    { return o.Super() }
func (o class) AsTranslation() Translation.Advanced         { return Translation.Advanced{gdclass.NewTranslation(o[0].AsObject()[0])} }
func (o *Extension[T]) AsTranslation() Translation.Instance { return o.Super().AsTranslation() }
func (o Instance) AsTranslation() Translation.Instance      { return Translation.Instance{gdclass.NewTranslation(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("OptimizedTranslation", func(ptr gdreference.Object) any { return Instance{gdclass.NewOptimizedTranslation(ptr)} })
}
