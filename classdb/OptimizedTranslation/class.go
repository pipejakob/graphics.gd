...
func (self class) Generate(from [1]gdclass.Translation) bool { //gd:OptimizedTranslation.generate
	...
	runtime.KeepAlive(from[0].Anchor())
	var ret = r_ret
	return ret
}
...
func (o class) AsTranslation() Translation.Advanced         { return *(*Translation.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsTranslation() Translation.Instance { return o.Super().AsTranslation() }
func (o Instance) AsTranslation() Translation.Instance      { return *(*Translation.Instance)(ie.As(&o)) }
