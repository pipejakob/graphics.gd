...
type Instance [1]gdclass.VisualShaderNodeTexture2DParameter
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeTexture2DParameter")
...
type Any interface {
	gd.IsClass
	AsVisualShaderNodeTexture2DParameter() Instance
}

// Advanced exposes a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type Advanced = class
type class [1]gdclass.VisualShaderNodeTexture2DParameter

func (o class) AsObject() [1]gdreference.Object { return o[0].AsObject() }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeTexture2DParameter(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture2DParameter{gdclass.NewVisualShaderNodeTexture2DParameter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeTexture2DParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DParameter{gdclass.NewVisualShaderNodeTexture2DParameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVisualShaderNodeTexture2DParameter() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeTexture2DParameter() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeTexture2DParameter() Instance { return o.Super() }
func (o class) AsVisualShaderNodeTextureParameter() VisualShaderNodeTextureParameter.Advanced {
	return VisualShaderNodeTextureParameter.Advanced{gdclass.NewVisualShaderNodeTextureParameter(o[0].AsObject()[0])}
}
...
func (o Instance) AsVisualShaderNodeTextureParameter() VisualShaderNodeTextureParameter.Instance {
	return VisualShaderNodeTextureParameter.Instance{gdclass.NewVisualShaderNodeTextureParameter(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture2DParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTexture2DParameter(ptr)} })
}
