...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ShaderGlobalsOverride")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ShaderGlobalsOverride{gdclass.NewShaderGlobalsOverride(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
