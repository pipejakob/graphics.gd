...
func (o class) AsLightmapper() Lightmapper.Advanced         { return Lightmapper.Advanced{gdclass.NewLightmapper(o[0].AsObject()[0])} }
func (o *Extension[T]) AsLightmapper() Lightmapper.Instance { return o.Super().AsLightmapper() }
func (o Instance) AsLightmapper() Lightmapper.Instance      { return Lightmapper.Instance{gdclass.NewLightmapper(o[0].AsObject()[0])} }
