...
type Instance [1]gdclass.VisualShaderNodeProximityFade
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeProximityFade")
...
type Any interface {
	gd.IsClass
	AsVisualShaderNodeProximityFade() Instance
}

// Advanced exposes a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type Advanced = class
type class [1]gdclass.VisualShaderNodeProximityFade

func (o class) AsObject() [1]gdreference.Object { return o[0].AsObject() }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeProximityFade(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeProximityFade{gdclass.NewVisualShaderNodeProximityFade(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeProximityFade(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeProximityFade{gdclass.NewVisualShaderNodeProximityFade(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVisualShaderNodeProximityFade() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeProximityFade() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeProximityFade() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeProximityFade", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeProximityFade(ptr)} })
}
