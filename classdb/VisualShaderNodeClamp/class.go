...
var methods struct {
	set_op_type gdextension.MethodForClass `hash:"405010749"`
	get_op_type gdextension.MethodForClass `hash:"233276050"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeClamp")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeClamp(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeClamp{gdclass.NewVisualShaderNodeClamp(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeClamp(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeClamp{gdclass.NewVisualShaderNodeClamp(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) OpType() OpType { //gd:VisualShaderNodeClamp.op_type
...
func (self Instance) SetOpType(value OpType) Instance { //gd:VisualShaderNodeClamp.op_type
...
func (o class) AsVisualShaderNodeClamp() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeClamp() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeClamp() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeClamp", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeClamp(ptr)} })
}
