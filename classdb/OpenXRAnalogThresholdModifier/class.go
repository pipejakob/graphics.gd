...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRAnalogThresholdModifier{gdclass.NewOpenXRAnalogThresholdModifier(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
