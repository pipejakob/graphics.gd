...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RenderSceneDataExtension{gdclass.NewRenderSceneDataExtension(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetRenderSceneDataExtension(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RenderSceneDataExtension{gdclass.NewRenderSceneDataExtension(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsRenderSceneDataExtension() Advanced         { return Advanced(o) }
...
func init() {
	gdclass.Register("RenderSceneDataExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewRenderSceneDataExtension(ptr)} })
}
