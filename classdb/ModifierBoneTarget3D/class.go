...
type Instance [1]gdclass.ModifierBoneTarget3D
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ModifierBoneTarget3D")
...
type Any interface {
	gd.IsClass
	AsModifierBoneTarget3D() Instance
}

// Advanced exposes a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type Advanced = class
type class [1]gdclass.ModifierBoneTarget3D

func (o class) AsObject() [1]gdreference.Object { return o[0].AsObject() }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewModifierBoneTarget3D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ModifierBoneTarget3D{gdclass.NewModifierBoneTarget3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetModifierBoneTarget3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ModifierBoneTarget3D{gdclass.NewModifierBoneTarget3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsModifierBoneTarget3D() Advanced         { return Advanced(o) }
func (o Instance) AsModifierBoneTarget3D() Instance      { return o }
func (o *Extension[T]) AsModifierBoneTarget3D() Instance { return o.Super() }
...
func init() {
	gdclass.Register("ModifierBoneTarget3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewModifierBoneTarget3D(ptr)} })
}
