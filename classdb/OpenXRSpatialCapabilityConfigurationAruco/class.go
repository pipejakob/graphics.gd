...
func init() {
	gdclass.Register("OpenXRSpatialCapabilityConfigurationAruco", func(ptr gdreference.Object) any {
		return Instance{gdclass.NewOpenXRSpatialCapabilityConfigurationAruco(ptr)}
	})
}
