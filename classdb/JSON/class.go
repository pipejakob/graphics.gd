...
[@GlobalScope.Typeof]: https://pkg.go.dev/graphics.gd/classdb/@GlobalScope#Instance.Typeof
...
[String.ToFloat]: https://pkg.go.dev/graphics.gd/classdb/String#Instance.ToFloat
*/
package JSON
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.JSON{gdclass.NewJSON(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetJSON(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (self class) GetErrorLine() int64 { //gd:JSON.get_error_line
	var r_ret = jumponly.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_error_line, gdextension.SizeInt, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
...
func (o Instance) AsJSON() Instance                   { return o }
func (o *Extension[T]) AsJSON() Instance              { return o.Super() }
...
func init() {
	gdclass.Register("JSON", func(ptr gdreference.Object) any { return Instance{gdclass.NewJSON(ptr)} })
}
