...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorOp{gdclass.NewVisualShaderNodeColorOp(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
