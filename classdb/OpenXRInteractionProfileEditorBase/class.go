...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfileEditorBase{gdclass.NewOpenXRInteractionProfileEditorBase(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
