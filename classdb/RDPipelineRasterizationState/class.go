...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RDPipelineRasterizationState{gdclass.NewRDPipelineRasterizationState(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetRDPipelineRasterizationState(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RDPipelineRasterizationState{gdclass.NewRDPipelineRasterizationState(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsRDPipelineRasterizationState() Advanced         { return Advanced(o) }
func (o Instance) AsRDPipelineRasterizationState() Instance      { return o }
func (o *Extension[T]) AsRDPipelineRasterizationState() Instance { return o.Super() }
...
func init() {
	gdclass.Register("RDPipelineRasterizationState", func(ptr gdreference.Object) any { return Instance{gdclass.NewRDPipelineRasterizationState(ptr)} })
}
