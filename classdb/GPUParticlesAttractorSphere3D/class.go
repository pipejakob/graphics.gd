...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GPUParticlesAttractorSphere3D{gdclass.NewGPUParticlesAttractorSphere3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetGPUParticlesAttractorSphere3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractorSphere3D{gdclass.NewGPUParticlesAttractorSphere3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsGPUParticlesAttractorSphere3D() Advanced         { return Advanced(o) }
func (o Instance) AsGPUParticlesAttractorSphere3D() Instance      { return o }
func (o *Extension[T]) AsGPUParticlesAttractorSphere3D() Instance { return o.Super() }
...
func init() {
	gdclass.Register("GPUParticlesAttractorSphere3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewGPUParticlesAttractorSphere3D(ptr)} })
}
