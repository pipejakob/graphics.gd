...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisibleOnScreenNotifier2D{gdclass.NewVisibleOnScreenNotifier2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
