...
func (self class) IsJoyButtonPressed(device int64, button JoyButton) bool { //gd:Input.is_joy_button_pressed
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.is_joy_button_pressed, gdextension.SizeBool|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		device int64
		button int64
	}{device, int64(button)})
	var ret = r_ret
...
func (self class) IsActionPressed(action String.Name, exact_match bool) bool { //gd:Input.is_action_pressed
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.is_action_pressed, gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), &struct {
...
func (self class) IsActionJustPressed(action String.Name, exact_match bool) bool { //gd:Input.is_action_just_pressed
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.is_action_just_pressed, gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), &struct {
		action      gdextension.StringName
		exact_match bool
	}{pointers.Get(gd.InternalStringName(action)), exact_match})
	var ret = r_ret
...
func (self class) IsActionJustReleased(action String.Name, exact_match bool) bool { //gd:Input.is_action_just_released
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.is_action_just_released, gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), &struct {
		action      gdextension.StringName
		exact_match bool
	}{pointers.Get(gd.InternalStringName(action)), exact_match})
	var ret = r_ret
...
func (self class) IsActionJustPressedByEvent(action String.Name, event [1]gdclass.InputEvent, exact_match bool) bool { //gd:Input.is_action_just_pressed_by_event
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.is_action_just_pressed_by_event, gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeObject<<8)|(gdextension.SizeBool<<12), &struct {
		action      gdextension.StringName
...
func (self class) IsActionJustReleasedByEvent(action String.Name, event [1]gdclass.InputEvent, exact_match bool) bool { //gd:Input.is_action_just_released_by_event
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.is_action_just_released_by_event, gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeObject<<8)|(gdextension.SizeBool<<12), &struct {
		action      gdextension.StringName
		event       gdextension.Object
		exact_match bool
	}{pointers.Get(gd.InternalStringName(action)), gdextension.Object(gdreference.GetObject(gdclass.GetInputEvent(event[0])[0])), exact_match})
...
func (self class) GetActionStrength(action String.Name, exact_match bool) float64 { //gd:Input.get_action_strength
	once.Do(singleton)
	var r_ret = noescape.Call[float64](gdreference.GetObject(self.AsObject()[0]), methods.get_action_strength, gdextension.SizeFloat|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), &struct {
		action      gdextension.StringName
		exact_match bool
	}{pointers.Get(gd.InternalStringName(action)), exact_match})
	var ret = r_ret
...
func (self class) GetActionRawStrength(action String.Name, exact_match bool) float64 { //gd:Input.get_action_raw_strength
	once.Do(singleton)
	var r_ret = noescape.Call[float64](gdreference.GetObject(self.AsObject()[0]), methods.get_action_raw_strength, gdextension.SizeFloat|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), &struct {
		action      gdextension.StringName
		exact_match bool
	}{pointers.Get(gd.InternalStringName(action)), exact_match})
	var ret = r_ret
...
func (self class) GetAxis(negative_action String.Name, positive_action String.Name) float64 { //gd:Input.get_axis
	once.Do(singleton)
	var r_ret = noescape.Call[float64](gdreference.GetObject(self.AsObject()[0]), methods.get_axis, gdextension.SizeFloat|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), &struct {
...
func (self class) GetVector(negative_x String.Name, positive_x String.Name, negative_y String.Name, positive_y String.Name, deadzone float64) Vector2.XY { //gd:Input.get_vector
	once.Do(singleton)
	var r_ret = noescape.Call[Vector2.XY](gdreference.GetObject(self.AsObject()[0]), methods.get_vector, gdextension.SizeVector2|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeStringName<<12)|(gdextension.SizeStringName<<16)|(gdextension.SizeFloat<<20), &struct {
...
func (self class) AddJoyMapping(mapping String.Readable, update_existing bool) { //gd:Input.add_joy_mapping
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.add_joy_mapping, 0|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct {
...
func (self class) GetJoyAxis(device int64, axis JoyAxis) float64 { //gd:Input.get_joy_axis
	once.Do(singleton)
	var r_ret = noescape.Call[float64](gdreference.GetObject(self.AsObject()[0]), methods.get_joy_axis, gdextension.SizeFloat|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		device int64
		axis   int64
	}{device, int64(axis)})
	var ret = r_ret
...
func (self class) ShouldIgnoreDevice(vendor_id int64, product_id int64) bool { //gd:Input.should_ignore_device
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.should_ignore_device, gdextension.SizeBool|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		vendor_id  int64
		product_id int64
...
func (self class) VibrateHandheld(duration_ms int64, amplitude float64) { //gd:Input.vibrate_handheld
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.vibrate_handheld, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct {
		duration_ms int64
		amplitude   float64
...
func (self class) SetJoyLight(device int64, color Color.RGBA) { //gd:Input.set_joy_light
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.set_joy_light, 0|(gdextension.SizeInt<<4)|(gdextension.SizeColor<<8), &struct {
		device int64
		color  Color.RGBA
	}{device, color})
}
...
func (self class) ActionPress(action String.Name, strength float64) { //gd:Input.action_press
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.action_press, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeFloat<<8), &struct {
		action   gdextension.StringName
		strength float64
...
func (self class) SetCustomMouseCursor(image [1]gdclass.Resource, shape CursorShape, hotspot Vector2.XY) { //gd:Input.set_custom_mouse_cursor
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.set_custom_mouse_cursor, 0|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeVector2<<12), &struct {
...
func init() {
	gdclass.Register("Input", func(ptr gdreference.Object) any { return Instance{gdclass.NewInput(ptr)} })
}
