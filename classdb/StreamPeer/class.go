...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.StreamPeer{gdclass.NewStreamPeer(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetStreamPeer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.StreamPeer{gdclass.NewStreamPeer(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsStreamPeer() Advanced         { return Advanced(o) }
func (o Instance) AsStreamPeer() Instance      { return o }
func (o *Extension[T]) AsStreamPeer() Instance { return o.Super() }
...
func init() {
	gdclass.Register("StreamPeer", func(ptr gdreference.Object) any { return Instance{gdclass.NewStreamPeer(ptr)} })
}
