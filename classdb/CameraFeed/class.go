...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CameraFeed{gdclass.NewCameraFeed(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetCameraFeed(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (self Instance) OnFormatChanged(cb func(), flags ...Signal.Flags) Instance {
	...
	gd.ObjectConnect(self.AsObject()[0], gd.NewStringName("format_changed"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (o Instance) AsCameraFeed() Instance      { return o }
func (o *Extension[T]) AsCameraFeed() Instance { return o.Super() }
...
func init() {
	gdclass.Register("CameraFeed", func(ptr gdreference.Object) any { return Instance{gdclass.NewCameraFeed(ptr)} })
}
