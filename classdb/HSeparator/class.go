...
[HSeparator]: https://pkg.go.dev/graphics.gd/classdb/HSeparator
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("HSeparator")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewHSeparator(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.HSeparator{gdclass.NewHSeparator(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetHSeparator(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.HSeparator{gdclass.NewHSeparator(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsHSeparator() Advanced                    { return Advanced(o) }
func (o Instance) AsHSeparator() Instance                 { return o }
func (o *Extension[T]) AsHSeparator() Instance            { return o.Super() }
func (o class) AsSeparator() Separator.Advanced           { return Separator.Advanced{gdclass.NewSeparator(o[0].AsObject()[0])} }
func (o *Extension[T]) AsSeparator() Separator.Instance   { return o.Super().AsSeparator() }
func (o Instance) AsSeparator() Separator.Instance        { return Separator.Instance{gdclass.NewSeparator(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("HSeparator", func(ptr gdreference.Object) any { return Instance{gdclass.NewHSeparator(ptr)} })
}
