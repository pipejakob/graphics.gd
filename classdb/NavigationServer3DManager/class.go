...
[NavigationServer3DManager]: https://pkg.go.dev/graphics.gd/classdb/NavigationServer3DManager
*/
package NavigationServer3DManager
...
type Instance [1]gdclass.NavigationServer3DManager
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("NavigationServer3DManager")
...
var self [1]gdclass.NavigationServer3DManager
var once sync.Once

func singleton() {
	self[0] = gdclass.NewNavigationServer3DManager(gdreference.RawObject(gdextension.Host.Objects.Global(sname)))
}

/*
Registers a [NavigationServer3D] implementation by passing a 'name' and a func that returns a [NavigationServer3D] object.
...
type class [1]gdclass.NavigationServer3DManager

func (o class) AsObject() [1]gdreference.Object { return *(*[1]gdreference.Object)(ie.As(&o)) }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewNavigationServer3DManager(obj[0])
		return true
	}
	return false
}
...
func (self class) RegisterServer(name String.Readable, create_callback Callable.Function) { //gd:NavigationServer3DManager.register_server
	once.Do(singleton)
...
func (self class) SetDefaultServer(name String.Readable, priority int64) { //gd:NavigationServer3DManager.set_default_server
	once.Do(singleton)
...
func init() {
	gdclass.Register("NavigationServer3DManager", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationServer3DManager(ptr)} })
}
