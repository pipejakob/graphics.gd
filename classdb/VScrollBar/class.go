...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VScrollBar")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VScrollBar{gdclass.NewVScrollBar(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVScrollBar(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VScrollBar{gdclass.NewVScrollBar(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVScrollBar() Advanced                    { return Advanced(o) }
func (o Instance) AsVScrollBar() Instance                 { return o }
func (o *Extension[T]) AsVScrollBar() Instance            { return o.Super() }
...
func init() {
	gdclass.Register("VScrollBar", func(ptr gdreference.Object) any { return Instance{gdclass.NewVScrollBar(ptr)} })
}
