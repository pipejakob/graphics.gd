...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AudioEffectEQ10")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewAudioEffectEQ10(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectEQ10{gdclass.NewAudioEffectEQ10(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioEffectEQ10(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectEQ10{gdclass.NewAudioEffectEQ10(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsAudioEffectEQ10() Advanced                     { return Advanced(o) }
func (o Instance) AsAudioEffectEQ10() Instance                  { return o }
func (o *Extension[T]) AsAudioEffectEQ10() Instance             { return o.Super() }
func (o class) AsAudioEffectEQ() AudioEffectEQ.Advanced         { return AudioEffectEQ.Advanced{gdclass.NewAudioEffectEQ(o[0].AsObject()[0])} }
...
func (o Instance) AsAudioEffectEQ() AudioEffectEQ.Instance {
	return AudioEffectEQ.Instance{gdclass.NewAudioEffectEQ(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("AudioEffectEQ10", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectEQ10(ptr)} })
}
