...
var methods struct {
	set_compositor_effects gdextension.MethodForClass `hash:"381264803"`
	get_compositor_effects gdextension.MethodForClass `hash:"3995934104"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("Compositor")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewCompositor(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Compositor{gdclass.NewCompositor(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetCompositor(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Compositor{gdclass.NewCompositor(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) SetCompositorEffects(compositor_effects Array.Contains[[1]gdclass.CompositorEffect]) { //gd:Compositor.set_compositor_effects
	...
	runtime.KeepAlive(compositor_effects)
}
...
func (o Instance) AsCompositor() Instance             { return o }
func (o *Extension[T]) AsCompositor() Instance        { return o.Super() }
...
func init() {
	gdclass.Register("Compositor", func(ptr gdreference.Object) any { return Instance{gdclass.NewCompositor(ptr)} })
}
