...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeVectorRefract")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVectorRefract{gdclass.NewVisualShaderNodeVectorRefract(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeVectorRefract(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorRefract{gdclass.NewVisualShaderNodeVectorRefract(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVisualShaderNodeVectorRefract() Advanced         { return Advanced(o) }
...
func init() {
	gdclass.Register("VisualShaderNodeVectorRefract", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVectorRefract(ptr)} })
}
