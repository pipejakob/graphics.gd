...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleAccelerator{gdclass.NewVisualShaderNodeParticleAccelerator(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
