...
[Operator]: https://pkg.go.dev/graphics.gd/classdb/VisualShaderNodeIntOp#Instance.Operator
*/
...
var methods struct {
	set_operator gdextension.MethodForClass `hash:"1677909323"`
	get_operator gdextension.MethodForClass `hash:"1236987913"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeIntOp")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeIntOp(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeIntOp{gdclass.NewVisualShaderNodeIntOp(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeIntOp(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIntOp{gdclass.NewVisualShaderNodeIntOp(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) Operator() Operator { //gd:VisualShaderNodeIntOp.operator
...
func (self Instance) SetOperator(value Operator) Instance { //gd:VisualShaderNodeIntOp.operator
...
func (o class) AsVisualShaderNodeIntOp() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeIntOp() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeIntOp() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeIntOp", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeIntOp(ptr)} })
}

type Operator int64 //gd:VisualShaderNodeIntOp.Operator
