...
[CanvasModulate]: https://pkg.go.dev/graphics.gd/classdb/CanvasModulate
*/
...
func init() {
	gdclass.Register("CanvasModulate", func(ptr gdreference.Object) any { return Instance{gdclass.NewCanvasModulate(ptr)} })
}
