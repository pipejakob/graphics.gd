...
func (self class) GetException() [1]gdclass.JavaObject { //gd:JavaClassWrapper.get_exception
	once.Do(singleton)
	var r_ret = jumponly.Call[gdextension.Object](gdreference.GetObject(self.AsObject()[0]), methods.get_exception, gdextension.SizeObject, &struct{}{})
...
func init() {
	gdclass.Register("JavaClassWrapper", func(ptr gdreference.Object) any { return Instance{gdclass.NewJavaClassWrapper(ptr)} })
}
