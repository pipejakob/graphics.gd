...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeParticleOutput")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeParticleOutput(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleOutput{gdclass.NewVisualShaderNodeParticleOutput(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeParticleOutput(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleOutput{gdclass.NewVisualShaderNodeParticleOutput(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVisualShaderNodeParticleOutput() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeParticleOutput() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeParticleOutput() Instance { return o.Super() }
func (o class) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Advanced {
	return VisualShaderNodeOutput.Advanced{gdclass.NewVisualShaderNodeOutput(o[0].AsObject()[0])}
}
func (o *Extension[T]) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Instance {
	return o.Super().AsVisualShaderNodeOutput()
}
func (o Instance) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Instance {
	return VisualShaderNodeOutput.Instance{gdclass.NewVisualShaderNodeOutput(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeParticleOutput", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleOutput(ptr)} })
}
