...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCubemap{gdclass.NewVisualShaderNodeCubemap(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
