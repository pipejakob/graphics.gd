...
[AudioServer.GetBusEffect]: https://pkg.go.dev/graphics.gd/classdb/AudioServer#GetBusEffect
[AudioServer.RemoveBusEffect]: https://pkg.go.dev/graphics.gd/classdb/AudioServer#RemoveBusEffect
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AudioEffect")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewAudioEffect(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffect{gdclass.NewAudioEffect(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioEffect(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (o class) AsAudioEffect() Advanced               { return Advanced(o) }
func (o Instance) AsAudioEffect() Instance            { return o }
func (o *Extension[T]) AsAudioEffect() Instance       { return o.Super() }
...
func init() {
	gdclass.Register("AudioEffect", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffect(ptr)} })
}
