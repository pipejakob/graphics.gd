...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ScriptLanguage")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ScriptLanguage{gdclass.NewScriptLanguage(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetScriptLanguage(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ScriptLanguage{gdclass.NewScriptLanguage(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func init() {
	gdclass.Register("ScriptLanguage", func(ptr gdreference.Object) any { return Instance{gdclass.NewScriptLanguage(ptr)} })
}
