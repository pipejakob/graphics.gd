...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("RetargetModifier3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RetargetModifier3D{gdclass.NewRetargetModifier3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
