...
func init() {
	gdclass.Register("HTTPClient", func(ptr gdreference.Object) any { return Instance{gdclass.NewHTTPClient(ptr)} })
}
...
const (
	...
	//
	// - [MethodGet]: The resource has been fetched and is transmitted in the message body.
	//
	// - [MethodHead]: The entity headers are in the message body.
	//
	// - [MethodPost]: The resource describing the result of the action is transmitted in the message body.
	//
	// - [MethodTrace]: The message body contains the request message as received by the server.
