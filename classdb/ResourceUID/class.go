...
func singleton() {
	self[0] = gdclass.NewResourceUID(gdreference.RawObject(gdextension.Host.Objects.Global(sname)))
}
...
func (self class) CreateId() int64 { //gd:ResourceUID.create_id
	once.Do(singleton)
	var r_ret = noescape.Call[int64](gdreference.GetObject(self.AsObject()[0]), methods.create_id, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) HasId(id int64) bool { //gd:ResourceUID.has_id
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.has_id, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
	var ret = r_ret
	return ret
}
func (self class) AddId(id int64, path String.Readable) { //gd:ResourceUID.add_id
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.add_id, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct {
		id   int64
...
func (self class) SetId(id int64, path String.Readable) { //gd:ResourceUID.set_id
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.set_id, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct {
		id   int64
		path gdextension.String
	}{id, pointers.Get(gd.InternalString(path))})
}
...
func (self class) RemoveId(id int64) { //gd:ResourceUID.remove_id
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.remove_id, 0|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
}
...
func init() {
	gdclass.Register("ResourceUID", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceUID(ptr)} })
}
