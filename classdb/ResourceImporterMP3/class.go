...
[ResourceImporterOggVorbis]: https://pkg.go.dev/graphics.gd/classdb/ResourceImporterOggVorbis
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ResourceImporterMP3")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewResourceImporterMP3(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterMP3{gdclass.NewResourceImporterMP3(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetResourceImporterMP3(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterMP3{gdclass.NewResourceImporterMP3(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsResourceImporterMP3() Advanced         { return Advanced(o) }
func (o Instance) AsResourceImporterMP3() Instance      { return o }
func (o *Extension[T]) AsResourceImporterMP3() Instance { return o.Super() }
...
func init() {
	gdclass.Register("ResourceImporterMP3", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceImporterMP3(ptr)} })
}
