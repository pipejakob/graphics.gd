...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeTransformParameter(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTransformParameter{gdclass.NewVisualShaderNodeTransformParameter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeTransformParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformParameter{gdclass.NewVisualShaderNodeTransformParameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) DefaultValueEnabled() bool { //gd:VisualShaderNodeTransformParameter.default_value_enabled
...
func (self Instance) SetDefaultValueEnabled(value bool) Instance { //gd:VisualShaderNodeTransformParameter.default_value_enabled
...
*/
func (self Instance) DefaultValue() Transform3D.BasisOrigin { //gd:VisualShaderNodeTransformParameter.default_value
...
func (self Instance) SetDefaultValue(value Transform3D.BasisOrigin) Instance { //gd:VisualShaderNodeTransformParameter.default_value
...
func (self class) SetDefaultValue(value Transform3D.BasisOrigin) { //gd:VisualShaderNodeTransformParameter.set_default_value
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_default_value, 0|(gdextension.SizeTransform3D<<4), &struct{ value Transform3D.BasisOrigin }{gd.Transposed(value)})
	runtime.KeepAlive(self[0].Anchor())
}
func (self class) GetDefaultValue() Transform3D.BasisOrigin { //gd:VisualShaderNodeTransformParameter.get_default_value
	var r_ret = jumponly.Call[Transform3D.BasisOrigin](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeTransform3D, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = gd.Transposed(r_ret)
	return ret
}
func (o class) AsVisualShaderNodeTransformParameter() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeTransformParameter() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeTransformParameter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeTransformParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTransformParameter(ptr)} })
}
