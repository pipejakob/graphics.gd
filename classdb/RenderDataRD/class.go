...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RenderDataRD{gdclass.NewRenderDataRD(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetRenderDataRD(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RenderDataRD{gdclass.NewRenderDataRD(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsRenderDataRD() Advanced                  { return Advanced(o) }
func (o Instance) AsRenderDataRD() Instance               { return o }
func (o *Extension[T]) AsRenderDataRD() Instance          { return o.Super() }
func (o class) AsRenderData() RenderData.Advanced         { return RenderData.Advanced{gdclass.NewRenderData(o[0].AsObject()[0])} }
func (o *Extension[T]) AsRenderData() RenderData.Instance { return o.Super().AsRenderData() }
func (o Instance) AsRenderData() RenderData.Instance      { return RenderData.Instance{gdclass.NewRenderData(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("RenderDataRD", func(ptr gdreference.Object) any { return Instance{gdclass.NewRenderDataRD(ptr)} })
}
