...
[VisualShaderNodeExpression]: https://pkg.go.dev/graphics.gd/classdb/VisualShaderNodeExpression
*/
...
func init() {
	gdclass.Register("VisualShaderNodeGlobalExpression", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeGlobalExpression(ptr)} })
}
