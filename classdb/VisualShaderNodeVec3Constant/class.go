...
var methods struct {
	set_constant gdextension.MethodForClass `hash:"3460891852"`
	get_constant gdextension.MethodForClass `hash:"3360562783"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeVec3Constant")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeVec3Constant(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVec3Constant{gdclass.NewVisualShaderNodeVec3Constant(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeVec3Constant(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Constant{gdclass.NewVisualShaderNodeVec3Constant(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetConstant() Vector3.XYZ { //gd:VisualShaderNodeVec3Constant.get_constant
	var r_ret = jumponly.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeVec3Constant() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeVec3Constant() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeVec3Constant() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeVec3Constant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec3Constant(ptr)} })
}
