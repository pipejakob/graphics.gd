...
[MeshInstance3D.CreateMultipleConvexCollisions]: https://pkg.go.dev/graphics.gd/classdb/MeshInstance3D#Instance.CreateMultipleConvexCollisions
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewConvexPolygonShape3D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ConvexPolygonShape3D{gdclass.NewConvexPolygonShape3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetConvexPolygonShape3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ConvexPolygonShape3D{gdclass.NewConvexPolygonShape3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o Instance) AsConvexPolygonShape3D() Instance      { return o }
func (o *Extension[T]) AsConvexPolygonShape3D() Instance { return o.Super() }
...
func init() {
	gdclass.Register("ConvexPolygonShape3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewConvexPolygonShape3D(ptr)} })
}
