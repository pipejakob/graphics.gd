...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackInteractive{gdclass.NewAudioStreamPlaybackInteractive(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
