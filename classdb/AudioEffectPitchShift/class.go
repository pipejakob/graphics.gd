...
/*
The pitch scale to use. 1.0 is the default pitch and plays sounds unaffected. [PitchScale] can range from 0 (infinitely low pitch, inaudible) to 16 (16 times higher than the initial pitch).
...
func (self class) GetOversampling() int64 { //gd:AudioEffectPitchShift.get_oversampling
	var r_ret = jumponly.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_oversampling, gdextension.SizeInt, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
...
func init() {
	gdclass.Register("AudioEffectPitchShift", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectPitchShift(ptr)} })
}
