...
var methods struct {
	...
	set_default_value         gdextension.MethodForClass `hash:"2920490490"`
	get_default_value         gdextension.MethodForClass `hash:"3444240500"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeColorParameter")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeColorParameter(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeColorParameter{gdclass.NewVisualShaderNodeColorParameter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeColorParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorParameter{gdclass.NewVisualShaderNodeColorParameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetDefaultValue() Color.RGBA { //gd:VisualShaderNodeColorParameter.get_default_value
	var r_ret = jumponly.Call[Color.RGBA](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeColor, &struct{}{})
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeColorParameter() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeColorParameter() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeColorParameter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeColorParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeColorParameter(ptr)} })
}
