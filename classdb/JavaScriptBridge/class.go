...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("JavaScriptBridge")
...
func singleton() {
	self[0] = gdclass.NewJavaScriptBridge(gdreference.RawObject(gdextension.Host.Objects.Global(sname)))
}
