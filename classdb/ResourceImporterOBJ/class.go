...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterOBJ{gdclass.NewResourceImporterOBJ(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetResourceImporterOBJ(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterOBJ{gdclass.NewResourceImporterOBJ(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsResourceImporterOBJ() Advanced         { return Advanced(o) }
func (o Instance) AsResourceImporterOBJ() Instance      { return o }
func (o *Extension[T]) AsResourceImporterOBJ() Instance { return o.Super() }
...
func init() {
	gdclass.Register("ResourceImporterOBJ", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceImporterOBJ(ptr)} })
}
