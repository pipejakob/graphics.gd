...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture3D{gdclass.NewVisualShaderNodeTexture3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
