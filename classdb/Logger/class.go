...
func (Instance) _log_error(impl func(ptr gdclass.Receiver, function string, file string, line int, code string, rationale string, editor_notify bool, error_type int, script_backtraces []ScriptBacktrace.Instance)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		...
		var file = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 1)))))
		defer pointers.End(gd.InternalString(file))
		var line = gd.UnsafeGet[int64](p_args, 2)
		var code = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 3)))))
		defer pointers.End(gd.InternalString(code))
		var rationale = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 4)))))
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Logger{gdclass.NewLogger(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetLogger(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (o class) AsLogger() Advanced          { return Advanced(o) }
func (o Instance) AsLogger() Instance       { return o }
func (o *Extension[T]) AsLogger() Instance  { return o.Super() }
...
func init() {
	gdclass.Register("Logger", func(ptr gdreference.Object) any { return Instance{gdclass.NewLogger(ptr)} })
}
