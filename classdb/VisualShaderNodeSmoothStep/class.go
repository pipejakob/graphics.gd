...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeSmoothStep(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeSmoothStep{gdclass.NewVisualShaderNodeSmoothStep(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeSmoothStep(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSmoothStep{gdclass.NewVisualShaderNodeSmoothStep(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) OpType() OpType { //gd:VisualShaderNodeSmoothStep.op_type
...
func (self Instance) SetOpType(value OpType) Instance { //gd:VisualShaderNodeSmoothStep.op_type
...
func (o class) AsVisualShaderNodeSmoothStep() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeSmoothStep() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeSmoothStep() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeSmoothStep", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeSmoothStep(ptr)} })
}
