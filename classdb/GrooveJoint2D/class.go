...
func New() Instance {
	...
	casted := Instance([1]gdclass.GrooveJoint2D{gdclass.NewGrooveJoint2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsJoint2D() Joint2D.Advanced               { return Joint2D.Advanced{gdclass.NewJoint2D(o[0].AsObject()[0])} }
func (o *Extension[T]) AsJoint2D() Joint2D.Instance       { return o.Super().AsJoint2D() }
func (o Instance) AsJoint2D() Joint2D.Instance            { return Joint2D.Instance{gdclass.NewJoint2D(o[0].AsObject()[0])} }
