...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("TwoBoneIK3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TwoBoneIK3D{gdclass.NewTwoBoneIK3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
