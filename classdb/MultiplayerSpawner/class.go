...
[AddSpawnableScene]: https://pkg.go.dev/graphics.gd/classdb/MultiplayerSpawner#Instance.AddSpawnableScene
...
func init() {
	gdclass.Register("MultiplayerSpawner", func(ptr gdreference.Object) any { return Instance{gdclass.NewMultiplayerSpawner(ptr)} })
}
