...
[GDExtensionManager]: https://pkg.go.dev/graphics.gd/classdb/GDExtensionManager
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewGDExtension(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GDExtension{gdclass.NewGDExtension(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetGDExtension(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.GDExtension{gdclass.NewGDExtension(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsGDExtension() Advanced               { return Advanced(o) }
func (o Instance) AsGDExtension() Instance            { return o }
func (o *Extension[T]) AsGDExtension() Instance       { return o.Super() }
...
func init() {
	gdclass.Register("GDExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewGDExtension(ptr)} })
}
