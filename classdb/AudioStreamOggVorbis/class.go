...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamOggVorbis{gdclass.NewAudioStreamOggVorbis(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
[BeatCount]: https://pkg.go.dev/graphics.gd/classdb/AudioStreamOggVorbis#Instance.BeatCount
...
func (self class) SetPacketSequence(packet_sequence [1]gdclass.OggPacketSequence) { //gd:AudioStreamOggVorbis.set_packet_sequence
	...
	runtime.KeepAlive(packet_sequence[0].Anchor())
}
