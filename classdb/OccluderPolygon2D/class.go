...
func init() {
	gdclass.Register("OccluderPolygon2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewOccluderPolygon2D(ptr)} })
}
...
const (
	...
	//
	// [CullMode]: https://pkg.go.dev/graphics.gd/classdb/#Instance.CullMode
