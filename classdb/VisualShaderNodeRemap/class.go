...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeRemap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeRemap{gdclass.NewVisualShaderNodeRemap(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
