...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeBooleanConstant{gdclass.NewVisualShaderNodeBooleanConstant(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeBooleanConstant(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBooleanConstant{gdclass.NewVisualShaderNodeBooleanConstant(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetConstant() bool { //gd:VisualShaderNodeBooleanConstant.get_constant
	var r_ret = jumponly.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func init() {
	gdclass.Register("VisualShaderNodeBooleanConstant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeBooleanConstant(ptr)} })
}
