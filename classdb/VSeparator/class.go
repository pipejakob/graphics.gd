...
[VSeparator]: https://pkg.go.dev/graphics.gd/classdb/VSeparator
*/
package VSeparator
...
func init() {
	gdclass.Register("VSeparator", func(ptr gdreference.Object) any { return Instance{gdclass.NewVSeparator(ptr)} })
}
