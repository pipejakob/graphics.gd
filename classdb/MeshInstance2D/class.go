...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.MeshInstance2D{gdclass.NewMeshInstance2D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetMeshInstance2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.MeshInstance2D{gdclass.NewMeshInstance2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsMeshInstance2D() Advanced                { return Advanced(o) }
func (o Instance) AsMeshInstance2D() Instance             { return o }
func (o *Extension[T]) AsMeshInstance2D() Instance        { return o.Super() }
...
func init() {
	gdclass.Register("MeshInstance2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewMeshInstance2D(ptr)} })
}
