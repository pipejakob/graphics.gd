...
[Operator]: https://pkg.go.dev/graphics.gd/classdb/VisualShaderNodeFloatOp#Instance.Operator
*/
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeFloatOp(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeFloatOp{gdclass.NewVisualShaderNodeFloatOp(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeFloatOp(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatOp{gdclass.NewVisualShaderNodeFloatOp(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsVisualShaderNodeFloatOp() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeFloatOp() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeFloatOp() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeFloatOp", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeFloatOp(ptr)} })
}

type Operator int64 //gd:VisualShaderNodeFloatOp.Operator
