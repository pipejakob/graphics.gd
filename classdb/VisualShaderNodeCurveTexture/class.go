...
var methods struct {
	set_texture gdextension.MethodForClass `hash:"181872837"`
	get_texture gdextension.MethodForClass `hash:"2800800579"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeCurveTexture")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeCurveTexture(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeCurveTexture{gdclass.NewVisualShaderNodeCurveTexture(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeCurveTexture(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCurveTexture{gdclass.NewVisualShaderNodeCurveTexture(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
The source texture.
*/
func (self Instance) Texture() CurveTexture.Instance { //gd:VisualShaderNodeCurveTexture.texture
...
func (self Instance) SetTexture(value CurveTexture.Instance) Instance { //gd:VisualShaderNodeCurveTexture.texture
...
func (self class) GetTexture() [1]gdclass.CurveTexture { //gd:VisualShaderNodeCurveTexture.get_texture
	...
	runtime.KeepAlive(self[0].Anchor())
	var ret = [1]gdclass.CurveTexture{gdclass.NewCurveTexture(gd.PointerWithOwnershipTransferredToGo(r_ret))}
	return ret
}
func (o class) AsVisualShaderNodeCurveTexture() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeCurveTexture() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeCurveTexture() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeCurveTexture", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeCurveTexture(ptr)} })
}
