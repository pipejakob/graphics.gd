...
type MoreArgs [1]gdclass.KinematicCollision2D
...
Returns the collision angle according to 'up_direction', which is [Vector2.Up] by default. This value is always positive.
*/
func (self MoreArgs) GetAngle(up_direction Vector2.XY) Angle.Radians { //gd:KinematicCollision2D.get_angle
...
/*
Returns the colliding body's [Resource.ID] used by the [PhysicsServer2D].
...
func New() Instance {
	if !gd.Linked {
		...
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				...
				gdreference.SetObject(gdclass.GetKinematicCollision2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.KinematicCollision2D{gdclass.NewKinematicCollision2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetAngle(up_direction Vector2.XY) float64 { //gd:KinematicCollision2D.get_angle
	var r_ret = noescape.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_angle, gdextension.SizeFloat|(gdextension.SizeVector2<<4), &struct{ up_direction Vector2.XY }{up_direction})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
...
func (self class) GetColliderShapeIndex() int64 { //gd:KinematicCollision2D.get_collider_shape_index
	var r_ret = jumponly.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_collider_shape_index, gdextension.SizeInt, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
...
func (o class) AsKinematicCollision2D() Advanced         { return Advanced(o) }
func (o Instance) AsKinematicCollision2D() Instance      { return o }
func (o *Extension[T]) AsKinematicCollision2D() Instance { return o.Super() }
