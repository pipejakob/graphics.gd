...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationMeshSourceGeometryData2D{gdclass.NewNavigationMeshSourceGeometryData2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
