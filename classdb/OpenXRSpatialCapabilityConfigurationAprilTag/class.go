...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("OpenXRSpatialCapabilityConfigurationAprilTag")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialCapabilityConfigurationAprilTag{gdclass.NewOpenXRSpatialCapabilityConfigurationAprilTag(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
