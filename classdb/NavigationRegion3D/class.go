...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.NavigationRegion3D{gdclass.NewNavigationRegion3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetNavigationRegion3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.NavigationRegion3D{gdclass.NewNavigationRegion3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) SetNavigationMesh(navigation_mesh [1]gdclass.NavigationMesh) { //gd:NavigationRegion3D.set_navigation_mesh
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_navigation_mesh, 0|(gdextension.SizeObject<<4), &struct{ navigation_mesh gdextension.Object }{gdextension.Object(gdreference.GetObject(gdclass.GetNavigationMesh(navigation_mesh[0])[0]))})
}
func (self class) GetNavigationMesh() [1]gdclass.NavigationMesh { //gd:NavigationRegion3D.get_navigation_mesh
	var r_ret = jumponly.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_navigation_mesh, gdextension.SizeObject, &struct{}{})
...
func (self Instance) OnNavigationMeshChanged(cb func(), flags ...Signal.Flags) Instance {
	...
	gd.ObjectConnect(self.AsObject()[0], gd.NewStringName("navigation_mesh_changed"), gd.NewCallable(cb), int64(flags_together))
	return self
}

func (self class) NavigationMeshChanged() Signal.Any {
	return Signal.Via(gd.WrapSignal(gd.NewSignalOf(self.AsObject(), gd.NewStringName(`navigation_mesh_changed`))))
}
...
func (self class) BakeFinished() Signal.Any {
	return Signal.Via(gd.WrapSignal(gd.NewSignalOf(self.AsObject(), gd.NewStringName(`bake_finished`))))
}
...
func init() {
	gdclass.Register("NavigationRegion3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationRegion3D(ptr)} })
}
