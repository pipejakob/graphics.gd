...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureParameter{gdclass.NewVisualShaderNodeTextureParameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
