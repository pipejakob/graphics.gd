...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ResourceImporterDynamicFont")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewResourceImporterDynamicFont(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterDynamicFont{gdclass.NewResourceImporterDynamicFont(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetResourceImporterDynamicFont(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterDynamicFont{gdclass.NewResourceImporterDynamicFont(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsResourceImporterDynamicFont() Advanced         { return Advanced(o) }
func (o Instance) AsResourceImporterDynamicFont() Instance      { return o }
func (o *Extension[T]) AsResourceImporterDynamicFont() Instance { return o.Super() }
...
func init() {
	gdclass.Register("ResourceImporterDynamicFont", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceImporterDynamicFont(ptr)} })
}
