...
[CanHandle]: https://pkg.go.dev/graphics.gd/classdb/EditorInspectorPlugin#Interface
...
[EditorPlugin.AddInspectorPlugin]: https://pkg.go.dev/graphics.gd/classdb/EditorPlugin#Instance.AddInspectorPlugin
[ParseBegin]: https://pkg.go.dev/graphics.gd/classdb/EditorInspectorPlugin#Interface
[ParseCategory]: https://pkg.go.dev/graphics.gd/classdb/EditorInspectorPlugin#Interface
[ParseEnd]: https://pkg.go.dev/graphics.gd/classdb/EditorInspectorPlugin#Interface
[ParseProperty]: https://pkg.go.dev/graphics.gd/classdb/EditorInspectorPlugin#Interface
*/
...
func (Instance) _parse_category(impl func(ptr gdclass.Receiver, obj Object.Instance, category string)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var obj = [1]gdreference.Object{gdreference.OwnObject(gd.UnsafeGet[gdextension.Object](p_args, 0), gd.Free)}
		defer gdreference.EndObject(obj[0])
		var category = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 1)))))
...
func (Instance) _parse_group(impl func(ptr gdclass.Receiver, obj Object.Instance, group string)) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var obj = [1]gdreference.Object{gdreference.OwnObject(gd.UnsafeGet[gdextension.Object](p_args, 0), gd.Free)}
		defer gdreference.EndObject(obj[0])
		var group = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 1)))))
...
func (Instance) _parse_property(impl func(ptr gdclass.Receiver, obj Object.Instance, atype variant.Type, name string, hint_type ClassDB.PropertyHint, hint_string string, usage_flags ClassDB.PropertyUsageFlags, wide bool) bool) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		...
		var name = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 2)))))
		defer pointers.End(gd.InternalString(name))
		var hint_type = gd.UnsafeGet[ClassDB.PropertyHint](p_args, 3)
		var hint_string = String.Via(gd.WrapString(pointers.Pin(pointers.New[gd.String](gd.UnsafeGet[gdextension.String](p_args, 4)))))
