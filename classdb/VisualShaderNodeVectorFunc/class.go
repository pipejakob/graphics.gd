...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorFunc{gdclass.NewVisualShaderNodeVectorFunc(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
