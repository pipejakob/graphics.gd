...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("MultiMeshInstance3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MultiMeshInstance3D{gdclass.NewMultiMeshInstance3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
