...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderSceneBuffersExtension{gdclass.NewRenderSceneBuffersExtension(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
