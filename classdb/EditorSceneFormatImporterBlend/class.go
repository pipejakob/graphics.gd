...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("EditorSceneFormatImporterBlend")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterBlend{gdclass.NewEditorSceneFormatImporterBlend(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
