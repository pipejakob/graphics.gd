...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeVec2Parameter(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVec2Parameter{gdclass.NewVisualShaderNodeVec2Parameter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeVec2Parameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec2Parameter{gdclass.NewVisualShaderNodeVec2Parameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
[DefaultValue]: https://pkg.go.dev/graphics.gd/classdb/VisualShaderNodeVec2Parameter#Instance.DefaultValue
*/
func (self Instance) DefaultValueEnabled() bool { //gd:VisualShaderNodeVec2Parameter.default_value_enabled
...
func (self Instance) SetDefaultValueEnabled(value bool) Instance { //gd:VisualShaderNodeVec2Parameter.default_value_enabled
...
*/
func (self Instance) DefaultValue() Vector2.XY { //gd:VisualShaderNodeVec2Parameter.default_value
...
func (self Instance) SetDefaultValue(value Vector2.XY) Instance { //gd:VisualShaderNodeVec2Parameter.default_value
...
func (self class) SetDefaultValue(value Vector2.XY) { //gd:VisualShaderNodeVec2Parameter.set_default_value
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_default_value, 0|(gdextension.SizeVector2<<4), &struct{ value Vector2.XY }{value})
}
func (self class) GetDefaultValue() Vector2.XY { //gd:VisualShaderNodeVec2Parameter.get_default_value
	var r_ret = jumponly.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeVec2Parameter() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeVec2Parameter() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeVec2Parameter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeVec2Parameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec2Parameter(ptr)} })
}
