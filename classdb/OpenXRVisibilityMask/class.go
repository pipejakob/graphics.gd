...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("OpenXRVisibilityMask")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewOpenXRVisibilityMask(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRVisibilityMask{gdclass.NewOpenXRVisibilityMask(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetOpenXRVisibilityMask(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRVisibilityMask{gdclass.NewOpenXRVisibilityMask(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsOpenXRVisibilityMask() Advanced         { return Advanced(o) }
func (o Instance) AsOpenXRVisibilityMask() Instance      { return o }
func (o *Extension[T]) AsOpenXRVisibilityMask() Instance { return o.Super() }
...
func init() {
	gdclass.Register("OpenXRVisibilityMask", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRVisibilityMask(ptr)} })
}
