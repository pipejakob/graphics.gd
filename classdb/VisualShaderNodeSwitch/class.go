...
[OpType]: https://pkg.go.dev/graphics.gd/classdb/VisualShaderNodeSwitch#Instance.OpType
*/
...
var methods struct {
	set_op_type gdextension.MethodForClass `hash:"510471861"`
	get_op_type gdextension.MethodForClass `hash:"2517845071"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeSwitch")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeSwitch(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeSwitch{gdclass.NewVisualShaderNodeSwitch(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeSwitch(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSwitch{gdclass.NewVisualShaderNodeSwitch(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) OpType() OpType { //gd:VisualShaderNodeSwitch.op_type
...
func (self Instance) SetOpType(value OpType) Instance { //gd:VisualShaderNodeSwitch.op_type
	class(self).SetOpType(value)
	return self
}

func (self class) SetOpType(atype OpType) { //gd:VisualShaderNodeSwitch.set_op_type
...
func (self class) GetOpType() OpType { //gd:VisualShaderNodeSwitch.get_op_type
	var r_ret = jumponly.Call[OpType](gd.ObjectChecked(self.AsObject()), methods.get_op_type, gdextension.SizeInt, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeSwitch() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeSwitch() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeSwitch() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeSwitch", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeSwitch(ptr)} })
}
