...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ScriptCreateDialog")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScriptCreateDialog{gdclass.NewScriptCreateDialog(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) ScriptCreated() Signal.Any {
	return Signal.Via(gd.WrapSignal(gd.NewSignalOf(self.AsObject(), gd.NewStringName(`script_created`))))
}
