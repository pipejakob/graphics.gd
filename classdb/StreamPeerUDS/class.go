...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("StreamPeerUDS")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StreamPeerUDS{gdclass.NewStreamPeerUDS(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
