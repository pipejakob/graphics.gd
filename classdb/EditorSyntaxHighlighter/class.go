...
Add a syntax highlighter to an individual script by calling [ScriptEditorBase.AddSyntaxHighlighter]. To apply to all scripts on open, call [ScriptEditor.RegisterSyntaxHighlighter].

[ScriptEditor]: https://pkg.go.dev/graphics.gd/classdb/ScriptEditor
[ScriptEditor.RegisterSyntaxHighlighter]: https://pkg.go.dev/graphics.gd/classdb/ScriptEditor#Instance.RegisterSyntaxHighlighter
[ScriptEditorBase.AddSyntaxHighlighter]: https://pkg.go.dev/graphics.gd/classdb/ScriptEditorBase#Instance.AddSyntaxHighlighter
...
Virtual method which can be overridden to return the supported language names.
*/
func (Instance) _get_supported_languages(impl func(ptr gdclass.Receiver) []string) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		self := gdclass.ReceiverOf(class)
		ret := impl(self)
...
func (Instance) _create(impl func(ptr gdclass.Receiver) Instance) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		self := gdclass.ReceiverOf(class)
		ret := impl(self)
		ptr, ok := gdreference.EndObject(gdclass.GetEditorSyntaxHighlighter(ret[0])[0])
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorSyntaxHighlighter{gdclass.NewEditorSyntaxHighlighter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetEditorSyntaxHighlighter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.EditorSyntaxHighlighter{gdclass.NewEditorSyntaxHighlighter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsEditorSyntaxHighlighter() Advanced         { return Advanced(o) }
func (o Instance) AsEditorSyntaxHighlighter() Instance      { return o }
func (o *Extension[T]) AsEditorSyntaxHighlighter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("EditorSyntaxHighlighter", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorSyntaxHighlighter(ptr)} })
}
