...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewLightOccluder2D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.LightOccluder2D{gdclass.NewLightOccluder2D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetLightOccluder2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.LightOccluder2D{gdclass.NewLightOccluder2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetOccluderLightMask() int64 { //gd:LightOccluder2D.get_occluder_light_mask
	var r_ret = jumponly.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_occluder_light_mask, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) IsSetAsSdfCollision() bool { //gd:LightOccluder2D.is_set_as_sdf_collision
	var r_ret = jumponly.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_set_as_sdf_collision, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (o class) AsLightOccluder2D() Advanced               { return Advanced(o) }
func (o Instance) AsLightOccluder2D() Instance            { return o }
func (o *Extension[T]) AsLightOccluder2D() Instance       { return o.Super() }
...
func init() {
	gdclass.Register("LightOccluder2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewLightOccluder2D(ptr)} })
}
