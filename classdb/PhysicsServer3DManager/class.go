...
[PhysicsServer3DManager]: https://pkg.go.dev/graphics.gd/classdb/PhysicsServer3DManager
*/
...
func singleton() {
	self[0] = gdclass.NewPhysicsServer3DManager(gdreference.RawObject(gdextension.Host.Objects.Global(sname)))
}

/*
Register a [PhysicsServer3D] implementation by passing a 'name' and a func that returns a [PhysicsServer3D] object.
...
func init() {
	gdclass.Register("PhysicsServer3DManager", func(ptr gdreference.Object) any { return Instance{gdclass.NewPhysicsServer3DManager(ptr)} })
}
