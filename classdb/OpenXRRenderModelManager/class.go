...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRRenderModelManager{gdclass.NewOpenXRRenderModelManager(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) SetMakeLocalToPose(make_local_to_pose String.Readable) { //gd:OpenXRRenderModelManager.set_make_local_to_pose
	...
	runtime.KeepAlive(self[0].Anchor())
	runtime.KeepAlive(make_local_to_pose)
}
