...
var methods struct {
	set_gizmo_extents gdextension.MethodForClass `hash:"373806689"`
	get_gizmo_extents gdextension.MethodForClass `hash:"1740695150"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("Marker2D")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewMarker2D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Marker2D{gdclass.NewMarker2D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetMarker2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Marker2D{gdclass.NewMarker2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) GizmoExtents() Float.X { //gd:Marker2D.gizmo_extents
...
func (self Instance) SetGizmoExtents(value Float.X) Instance { //gd:Marker2D.gizmo_extents
...
func (o class) AsMarker2D() Advanced                      { return Advanced(o) }
func (o Instance) AsMarker2D() Instance                   { return o }
func (o *Extension[T]) AsMarker2D() Instance              { return o.Super() }
...
func init() {
	gdclass.Register("Marker2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewMarker2D(ptr)} })
}
