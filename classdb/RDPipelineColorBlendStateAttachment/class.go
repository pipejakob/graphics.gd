...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RDPipelineColorBlendStateAttachment{gdclass.NewRDPipelineColorBlendStateAttachment(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetRDPipelineColorBlendStateAttachment(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RDPipelineColorBlendStateAttachment{gdclass.NewRDPipelineColorBlendStateAttachment(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsRDPipelineColorBlendStateAttachment() Advanced         { return Advanced(o) }
func (o Instance) AsRDPipelineColorBlendStateAttachment() Instance      { return o }
func (o *Extension[T]) AsRDPipelineColorBlendStateAttachment() Instance { return o.Super() }
...
func init() {
	gdclass.Register("RDPipelineColorBlendStateAttachment", func(ptr gdreference.Object) any { return Instance{gdclass.NewRDPipelineColorBlendStateAttachment(ptr)} })
}
