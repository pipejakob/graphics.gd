...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("SpotLight3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpotLight3D{gdclass.NewSpotLight3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
