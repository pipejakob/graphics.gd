...
[ResourceImporterImage]: https://pkg.go.dev/graphics.gd/classdb/ResourceImporterImage
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ResourceImporterTexture")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewResourceImporterTexture(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterTexture{gdclass.NewResourceImporterTexture(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetResourceImporterTexture(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterTexture{gdclass.NewResourceImporterTexture(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsResourceImporterTexture() Advanced         { return Advanced(o) }
func (o Instance) AsResourceImporterTexture() Instance      { return o }
func (o *Extension[T]) AsResourceImporterTexture() Instance { return o.Super() }
...
func init() {
	gdclass.Register("ResourceImporterTexture", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceImporterTexture(ptr)} })
}
