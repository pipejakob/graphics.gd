...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRCompositionLayerQuad{gdclass.NewOpenXRCompositionLayerQuad(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
