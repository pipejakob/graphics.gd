...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParameter{gdclass.NewVisualShaderNodeParameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
