...
var methods struct {
	set_pan_pullout  gdextension.MethodForClass `hash:"373806689"`
	get_pan_pullout  gdextension.MethodForClass `hash:"1740695150"`
	set_time_pullout gdextension.MethodForClass `hash:"373806689"`
	get_time_pullout gdextension.MethodForClass `hash:"1740695150"`
	set_surround     gdextension.MethodForClass `hash:"373806689"`
	get_surround     gdextension.MethodForClass `hash:"1740695150"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AudioEffectStereoEnhance")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectStereoEnhance{gdclass.NewAudioEffectStereoEnhance(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioEffectStereoEnhance(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectStereoEnhance{gdclass.NewAudioEffectStereoEnhance(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
/*
Widens the stereo image through phase shifting in conjunction with [TimePulloutMs]. Just pans sound to the left channel if [TimePulloutMs] is 0. Value can range from 0 to 1.
...
func init() {
	gdclass.Register("AudioEffectStereoEnhance", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectStereoEnhance(ptr)} })
}
