...
var methods struct {
	set_op_type gdextension.MethodForClass `hash:"2060089061"`
	get_op_type gdextension.MethodForClass `hash:"3597061078"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeParticleRandomness")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeParticleRandomness(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleRandomness{gdclass.NewVisualShaderNodeParticleRandomness(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeParticleRandomness(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleRandomness{gdclass.NewVisualShaderNodeParticleRandomness(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsVisualShaderNodeParticleRandomness() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeParticleRandomness() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeParticleRandomness() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeParticleRandomness", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleRandomness(ptr)} })
}
