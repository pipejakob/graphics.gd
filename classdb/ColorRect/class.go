...
[Color]: https://pkg.go.dev/graphics.gd/classdb/ColorRect#Instance.Color
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewColorRect(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ColorRect{gdclass.NewColorRect(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetColorRect(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ColorRect{gdclass.NewColorRect(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsColorRect() Advanced                     { return Advanced(o) }
func (o Instance) AsColorRect() Instance                  { return o }
func (o *Extension[T]) AsColorRect() Instance             { return o.Super() }
...
func init() {
	gdclass.Register("ColorRect", func(ptr gdreference.Object) any { return Instance{gdclass.NewColorRect(ptr)} })
}
