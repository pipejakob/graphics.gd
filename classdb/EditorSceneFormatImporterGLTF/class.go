...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("EditorSceneFormatImporterGLTF")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorSceneFormatImporterGLTF{gdclass.NewEditorSceneFormatImporterGLTF(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetEditorSceneFormatImporterGLTF(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterGLTF{gdclass.NewEditorSceneFormatImporterGLTF(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsEditorSceneFormatImporterGLTF() Advanced         { return Advanced(o) }
func (o Instance) AsEditorSceneFormatImporterGLTF() Instance      { return o }
func (o *Extension[T]) AsEditorSceneFormatImporterGLTF() Instance { return o.Super() }
...
func init() {
	gdclass.Register("EditorSceneFormatImporterGLTF", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorSceneFormatImporterGLTF(ptr)} })
}
