...
[ImageFormatLoaderExtension]: https://pkg.go.dev/graphics.gd/classdb/ImageFormatLoaderExtension
*/
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ImageFormatLoader")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewImageFormatLoader(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ImageFormatLoader{gdclass.NewImageFormatLoader(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetImageFormatLoader(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (o class) AsImageFormatLoader() Advanced         { return Advanced(o) }
func (o Instance) AsImageFormatLoader() Instance      { return o }
func (o *Extension[T]) AsImageFormatLoader() Instance { return o.Super() }
...
func init() {
	gdclass.Register("ImageFormatLoader", func(ptr gdreference.Object) any { return Instance{gdclass.NewImageFormatLoader(ptr)} })
}
