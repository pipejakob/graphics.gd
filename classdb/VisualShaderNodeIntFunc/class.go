...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeIntFunc")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIntFunc{gdclass.NewVisualShaderNodeIntFunc(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
