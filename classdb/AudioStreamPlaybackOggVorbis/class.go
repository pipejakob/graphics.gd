...
[OggPacketSequencePlayback]: https://pkg.go.dev/graphics.gd/classdb/OggPacketSequencePlayback
*/
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("AudioStreamPlaybackOggVorbis")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamPlaybackOggVorbis{gdclass.NewAudioStreamPlaybackOggVorbis(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioStreamPlaybackOggVorbis(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackOggVorbis{gdclass.NewAudioStreamPlaybackOggVorbis(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsAudioStreamPlaybackOggVorbis() Advanced         { return Advanced(o) }
func (o Instance) AsAudioStreamPlaybackOggVorbis() Instance      { return o }
func (o *Extension[T]) AsAudioStreamPlaybackOggVorbis() Instance { return o.Super() }
...
func init() {
	gdclass.Register("AudioStreamPlaybackOggVorbis", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamPlaybackOggVorbis(ptr)} })
}
