...
var methods struct {
	add_spacer    gdextension.MethodForClass `hash:"1326660695"`
	set_alignment gdextension.MethodForClass `hash:"2456745134"`
	get_alignment gdextension.MethodForClass `hash:"1915476527"`
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("BoxContainer")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewBoxContainer(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.BoxContainer{gdclass.NewBoxContainer(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetBoxContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.BoxContainer{gdclass.NewBoxContainer(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsBoxContainer() Advanced                  { return Advanced(o) }
func (o Instance) AsBoxContainer() Instance               { return o }
func (o *Extension[T]) AsBoxContainer() Instance          { return o.Super() }
...
func init() {
	gdclass.Register("BoxContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewBoxContainer(ptr)} })
}
