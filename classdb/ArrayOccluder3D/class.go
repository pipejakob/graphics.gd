...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ArrayOccluder3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ArrayOccluder3D{gdclass.NewArrayOccluder3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
