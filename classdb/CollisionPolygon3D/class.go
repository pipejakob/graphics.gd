...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("CollisionPolygon3D")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewCollisionPolygon3D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CollisionPolygon3D{gdclass.NewCollisionPolygon3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetCollisionPolygon3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CollisionPolygon3D{gdclass.NewCollisionPolygon3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsCollisionPolygon3D() Advanced         { return Advanced(o) }
func (o Instance) AsCollisionPolygon3D() Instance      { return o }
func (o *Extension[T]) AsCollisionPolygon3D() Instance { return o.Super() }
...
func init() {
	gdclass.Register("CollisionPolygon3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCollisionPolygon3D(ptr)} })
}
