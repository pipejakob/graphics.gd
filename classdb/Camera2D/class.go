...
[GetScreenCenterPosition]: https://pkg.go.dev/graphics.gd/classdb/Camera2D#Instance.GetScreenCenterPosition
[GetScreenRotation]: https://pkg.go.dev/graphics.gd/classdb/Camera2D#Instance.GetScreenRotation
...
[Node2D.GlobalPosition]: https://pkg.go.dev/graphics.gd/classdb/Node2D#Instance.GlobalPosition
...
[Viewport.CanvasTransform]: https://pkg.go.dev/graphics.gd/classdb/Viewport#Instance.CanvasTransform
*/
package Camera2D
...
[GetTargetPosition]: https://pkg.go.dev/graphics.gd/classdb/Camera2D#Instance.GetTargetPosition
*/
...
func init() {
	gdclass.Register("Camera2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCamera2D(ptr)} })
}
