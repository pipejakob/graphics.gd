...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRSpatialContextPersistenceConfig{gdclass.NewOpenXRSpatialContextPersistenceConfig(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetOpenXRSpatialContextPersistenceConfig(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (o class) AsOpenXRStructureBase() OpenXRStructureBase.Advanced {
	return OpenXRStructureBase.Advanced{gdclass.NewOpenXRStructureBase(o[0].AsObject()[0])}
}
...
func (o Instance) AsOpenXRStructureBase() OpenXRStructureBase.Instance {
	return OpenXRStructureBase.Instance{gdclass.NewOpenXRStructureBase(o[0].AsObject()[0])}
}
...
func init() {
	gdclass.Register("OpenXRSpatialContextPersistenceConfig", func(ptr gdreference.Object) any {
		return Instance{gdclass.NewOpenXRSpatialContextPersistenceConfig(ptr)}
	})
}
