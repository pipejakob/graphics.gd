...
/*
A "high-pass" filter attenuates frequencies lower than [AudioEffectFilter.CutoffHz] and allows higher frequencies to pass unchanged.
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewAudioEffectHighPassFilter(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectHighPassFilter{gdclass.NewAudioEffectHighPassFilter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioEffectHighPassFilter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectHighPassFilter{gdclass.NewAudioEffectHighPassFilter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsAudioEffectHighPassFilter() Advanced         { return Advanced(o) }
func (o Instance) AsAudioEffectHighPassFilter() Instance      { return o }
func (o *Extension[T]) AsAudioEffectHighPassFilter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("AudioEffectHighPassFilter", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectHighPassFilter(ptr)} })
}
