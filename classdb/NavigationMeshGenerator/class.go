...
[NavigationMeshGenerator]: https://pkg.go.dev/graphics.gd/classdb/NavigationMeshGenerator
...
func init() {
	gdclass.Register("NavigationMeshGenerator", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationMeshGenerator(ptr)} })
}
