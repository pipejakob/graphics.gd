...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewCompressedCubemapArray(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CompressedCubemapArray{gdclass.NewCompressedCubemapArray(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetCompressedCubemapArray(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CompressedCubemapArray{gdclass.NewCompressedCubemapArray(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsCompressedCubemapArray() Advanced         { return Advanced(o) }
func (o Instance) AsCompressedCubemapArray() Instance      { return o }
func (o *Extension[T]) AsCompressedCubemapArray() Instance { return o.Super() }
...
func init() {
	gdclass.Register("CompressedCubemapArray", func(ptr gdreference.Object) any { return Instance{gdclass.NewCompressedCubemapArray(ptr)} })
}
