...
/*
Object for storing the queries anchor result data when calling [OpenXRSpatialEntityExtension.QuerySnapshot].
...
type Instance [1]gdclass.OpenXRSpatialComponentAnchorList

var otype gdextension.ObjectType
var sname gdextension.StringName
var methods struct {
	get_entity_pose gdextension.MethodForClass `hash:"1965739696"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("OpenXRSpatialComponentAnchorList")
...
type Any interface {
	gd.IsClass
	AsOpenXRSpatialComponentAnchorList() Instance
}

/*
Returns the transform for the entity at this 'index'.
*/
func (self Instance) GetEntityPose(index int) Transform3D.BasisOrigin { //gd:OpenXRSpatialComponentAnchorList.get_entity_pose
	return Transform3D.BasisOrigin(Advanced(self).GetEntityPose(int64(index)))
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRSpatialComponentAnchorList{gdclass.NewOpenXRSpatialComponentAnchorList(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetOpenXRSpatialComponentAnchorList(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRSpatialComponentAnchorList{gdclass.NewOpenXRSpatialComponentAnchorList(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsOpenXRSpatialComponentAnchorList() Advanced         { return Advanced(o) }
...
func init() {
	gdclass.Register("OpenXRSpatialComponentAnchorList", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRSpatialComponentAnchorList(ptr)} })
}
