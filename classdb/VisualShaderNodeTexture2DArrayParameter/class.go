...
[VisualShaderNodeTexture2DArray]: https://pkg.go.dev/graphics.gd/classdb/VisualShaderNodeTexture2DArray
*/
...
func init() {
	gdclass.Register("VisualShaderNodeTexture2DArrayParameter", func(ptr gdreference.Object) any {
		return Instance{gdclass.NewVisualShaderNodeTexture2DArrayParameter(ptr)}
	})
}
