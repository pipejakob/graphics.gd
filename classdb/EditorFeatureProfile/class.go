...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorFeatureProfile{gdclass.NewEditorFeatureProfile(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetEditorFeatureProfile(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func (o class) AsEditorFeatureProfile() Advanced         { return Advanced(o) }
func (o Instance) AsEditorFeatureProfile() Instance      { return o }
func (o *Extension[T]) AsEditorFeatureProfile() Instance { return o.Super() }
...
func init() {
	gdclass.Register("EditorFeatureProfile", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorFeatureProfile(ptr)} })
}
