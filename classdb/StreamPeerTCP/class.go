...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.StreamPeerTCP{gdclass.NewStreamPeerTCP(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetStreamPeerTCP(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.StreamPeerTCP{gdclass.NewStreamPeerTCP(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsStreamPeerTCP() Advanced         { return Advanced(o) }
func (o Instance) AsStreamPeerTCP() Instance      { return o }
func (o *Extension[T]) AsStreamPeerTCP() Instance { return o.Super() }
...
func init() {
	gdclass.Register("StreamPeerTCP", func(ptr gdreference.Object) any { return Instance{gdclass.NewStreamPeerTCP(ptr)} })
}
