...
func init() {
	gdclass.Register("OpenXRFutureExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRFutureExtension(ptr)} })
}
