...
var methods struct {
	...
	set_default_value         gdextension.MethodForClass `hash:"2586408642"`
	get_default_value         gdextension.MethodForClass `hash:"36873697"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeBooleanParameter")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeBooleanParameter(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeBooleanParameter{gdclass.NewVisualShaderNodeBooleanParameter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeBooleanParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBooleanParameter{gdclass.NewVisualShaderNodeBooleanParameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetDefaultValue() bool { //gd:VisualShaderNodeBooleanParameter.get_default_value
	var r_ret = jumponly.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeBool, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeBooleanParameter() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeBooleanParameter() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeBooleanParameter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeBooleanParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeBooleanParameter(ptr)} })
}
