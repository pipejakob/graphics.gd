...
[AudioStreamSynchronized]: https://pkg.go.dev/graphics.gd/classdb/AudioStreamSynchronized
*/
...
func init() {
	gdclass.Register("AudioStreamPlaybackSynchronized", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamPlaybackSynchronized(ptr)} })
}
