...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeTransformConstant")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformConstant{gdclass.NewVisualShaderNodeTransformConstant(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
