...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("ResourceImporterBMFont")
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterBMFont{gdclass.NewResourceImporterBMFont(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetResourceImporterBMFont(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterBMFont{gdclass.NewResourceImporterBMFont(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsResourceImporterBMFont() Advanced         { return Advanced(o) }
func (o Instance) AsResourceImporterBMFont() Instance      { return o }
func (o *Extension[T]) AsResourceImporterBMFont() Instance { return o.Super() }
...
func init() {
	gdclass.Register("ResourceImporterBMFont", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceImporterBMFont(ptr)} })
}
