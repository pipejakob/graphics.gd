...
func New() Instance {
	...
	casted := Instance([1]gdclass.PackedScene{gdclass.NewPackedScene(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) Pack(path [1]gdclass.Node) Error.Code { //gd:PackedScene.pack
	...
	runtime.KeepAlive(path[0].Anchor())
