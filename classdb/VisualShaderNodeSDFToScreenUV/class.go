...
*/
package VisualShaderNodeSDFToScreenUV
...
type Instance [1]gdclass.VisualShaderNodeSDFToScreenUV
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeSDFToScreenUV")
...
type Any interface {
	gd.IsClass
	AsVisualShaderNodeSDFToScreenUV() Instance
}

// Advanced exposes a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type Advanced = class
type class [1]gdclass.VisualShaderNodeSDFToScreenUV

func (o class) AsObject() [1]gdreference.Object { return o[0].AsObject() }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeSDFToScreenUV(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeSDFToScreenUV{gdclass.NewVisualShaderNodeSDFToScreenUV(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeSDFToScreenUV(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSDFToScreenUV{gdclass.NewVisualShaderNodeSDFToScreenUV(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVisualShaderNodeSDFToScreenUV() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeSDFToScreenUV() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeSDFToScreenUV() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeSDFToScreenUV", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeSDFToScreenUV(ptr)} })
}
