...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VoxelGI{gdclass.NewVoxelGI(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVoxelGI(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VoxelGI{gdclass.NewVoxelGI(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) SetProbeData(data [1]gdclass.VoxelGIData) { //gd:VoxelGI.set_probe_data
	...
	runtime.KeepAlive(data[0].Anchor())
}
...
func (self class) SetCameraAttributes(camera_attributes [1]gdclass.CameraAttributes) { //gd:VoxelGI.set_camera_attributes
	...
	runtime.KeepAlive(self[0].Anchor())
	runtime.KeepAlive(camera_attributes[0].Anchor())
}
...
func (self class) Bake(from_node [1]gdclass.Node, create_visual_debug bool) { //gd:VoxelGI.bake
	...
	runtime.KeepAlive(self[0].Anchor())
	runtime.KeepAlive(from_node[0].Anchor())
}
...
func (o class) AsVoxelGI() Advanced         { return Advanced(o) }
func (o Instance) AsVoxelGI() Instance      { return o }
func (o *Extension[T]) AsVoxelGI() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VoxelGI", func(ptr gdreference.Object) any { return Instance{gdclass.NewVoxelGI(ptr)} })
}
