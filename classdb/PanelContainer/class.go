...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewPanelContainer(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PanelContainer{gdclass.NewPanelContainer(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetPanelContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.PanelContainer{gdclass.NewPanelContainer(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsPanelContainer() Advanced                { return Advanced(o) }
func (o Instance) AsPanelContainer() Instance             { return o }
func (o *Extension[T]) AsPanelContainer() Instance        { return o.Super() }
...
func init() {
	gdclass.Register("PanelContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewPanelContainer(ptr)} })
}
