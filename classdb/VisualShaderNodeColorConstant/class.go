...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorConstant{gdclass.NewVisualShaderNodeColorConstant(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
