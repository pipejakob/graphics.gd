...
*/
package EditorExportPlatformAppleEmbedded
...
type Instance [1]gdclass.EditorExportPlatformAppleEmbedded
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("EditorExportPlatformAppleEmbedded")
...
type Any interface {
	gd.IsClass
	AsEditorExportPlatformAppleEmbedded() Instance
}

// Advanced exposes a 1:1 low-level instance of the class, undocumented, for those who know what they are doing.
type Advanced = class
type class [1]gdclass.EditorExportPlatformAppleEmbedded

func (o class) AsObject() [1]gdreference.Object { return o[0].AsObject() }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewEditorExportPlatformAppleEmbedded(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorExportPlatformAppleEmbedded{gdclass.NewEditorExportPlatformAppleEmbedded(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetEditorExportPlatformAppleEmbedded(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.EditorExportPlatformAppleEmbedded{gdclass.NewEditorExportPlatformAppleEmbedded(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsEditorExportPlatformAppleEmbedded() Advanced         { return Advanced(o) }
func (o Instance) AsEditorExportPlatformAppleEmbedded() Instance      { return o }
func (o *Extension[T]) AsEditorExportPlatformAppleEmbedded() Instance { return o.Super() }
...
func init() {
	gdclass.Register("EditorExportPlatformAppleEmbedded", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorExportPlatformAppleEmbedded(ptr)} })
}
