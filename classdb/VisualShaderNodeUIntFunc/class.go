...
[Function]: https://pkg.go.dev/graphics.gd/classdb/VisualShaderNodeUIntFunc#Instance.Function
*/
...
var methods struct {
	set_function gdextension.MethodForClass `hash:"2273148961"`
	get_function gdextension.MethodForClass `hash:"4187123296"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeUIntFunc")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeUIntFunc(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeUIntFunc{gdclass.NewVisualShaderNodeUIntFunc(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeUIntFunc(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUIntFunc{gdclass.NewVisualShaderNodeUIntFunc(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) Function() Function { //gd:VisualShaderNodeUIntFunc.function
...
func (self Instance) SetFunction(value Function) Instance { //gd:VisualShaderNodeUIntFunc.function
	class(self).SetFunction(value)
	return self
}

func (self class) SetFunction(fn Function) { //gd:VisualShaderNodeUIntFunc.set_function
...
func (self class) GetFunction() Function { //gd:VisualShaderNodeUIntFunc.get_function
	var r_ret = jumponly.Call[Function](gd.ObjectChecked(self.AsObject()), methods.get_function, gdextension.SizeInt, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeUIntFunc() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeUIntFunc() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeUIntFunc() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeUIntFunc", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeUIntFunc(ptr)} })
}
