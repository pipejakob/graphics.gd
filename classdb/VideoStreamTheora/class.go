...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VideoStreamTheora")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVideoStreamTheora(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VideoStreamTheora{gdclass.NewVideoStreamTheora(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVideoStreamTheora(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VideoStreamTheora{gdclass.NewVideoStreamTheora(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsVideoStreamTheora() Advanced               { return Advanced(o) }
func (o Instance) AsVideoStreamTheora() Instance            { return o }
func (o *Extension[T]) AsVideoStreamTheora() Instance       { return o.Super() }
func (o class) AsVideoStream() VideoStream.Advanced         { return VideoStream.Advanced{gdclass.NewVideoStream(o[0].AsObject()[0])} }
func (o *Extension[T]) AsVideoStream() VideoStream.Instance { return o.Super().AsVideoStream() }
func (o Instance) AsVideoStream() VideoStream.Instance      { return VideoStream.Instance{gdclass.NewVideoStream(o[0].AsObject()[0])} }
...
func init() {
	gdclass.Register("VideoStreamTheora", func(ptr gdreference.Object) any { return Instance{gdclass.NewVideoStreamTheora(ptr)} })
}
