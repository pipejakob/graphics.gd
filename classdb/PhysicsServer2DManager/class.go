...
[PhysicsServer2DManager]: https://pkg.go.dev/graphics.gd/classdb/PhysicsServer2DManager
*/
...
func init() {
	gdclass.Register("PhysicsServer2DManager", func(ptr gdreference.Object) any { return Instance{gdclass.NewPhysicsServer2DManager(ptr)} })
}
