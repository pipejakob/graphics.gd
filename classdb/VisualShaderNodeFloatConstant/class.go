...
var methods struct {
	set_constant gdextension.MethodForClass `hash:"373806689"`
	get_constant gdextension.MethodForClass `hash:"1740695150"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeFloatConstant")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeFloatConstant(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeFloatConstant{gdclass.NewVisualShaderNodeFloatConstant(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeFloatConstant(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatConstant{gdclass.NewVisualShaderNodeFloatConstant(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) SetConstant(constant float64) { //gd:VisualShaderNodeFloatConstant.set_constant
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_constant, 0|(gdextension.SizeFloat<<4), &struct{ constant float64 }{constant})
}
func (self class) GetConstant() float64 { //gd:VisualShaderNodeFloatConstant.get_constant
	var r_ret = jumponly.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
func (o class) AsVisualShaderNodeFloatConstant() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeFloatConstant() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeFloatConstant() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeFloatConstant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeFloatConstant(ptr)} })
}
