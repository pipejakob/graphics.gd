...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("InputEventMagnifyGesture")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewInputEventMagnifyGesture(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InputEventMagnifyGesture{gdclass.NewInputEventMagnifyGesture(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetInputEventMagnifyGesture(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.InputEventMagnifyGesture{gdclass.NewInputEventMagnifyGesture(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsInputEventMagnifyGesture() Advanced         { return Advanced(o) }
func (o Instance) AsInputEventMagnifyGesture() Instance      { return o }
func (o *Extension[T]) AsInputEventMagnifyGesture() Instance { return o.Super() }
...
func init() {
	gdclass.Register("InputEventMagnifyGesture", func(ptr gdreference.Object) any { return Instance{gdclass.NewInputEventMagnifyGesture(ptr)} })
}
