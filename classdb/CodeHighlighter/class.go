...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CodeHighlighter{gdclass.NewCodeHighlighter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetCodeHighlighter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CodeHighlighter{gdclass.NewCodeHighlighter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsCodeHighlighter() Advanced         { return Advanced(o) }
...
func init() {
	gdclass.Register("CodeHighlighter", func(ptr gdreference.Object) any { return Instance{gdclass.NewCodeHighlighter(ptr)} })
}
