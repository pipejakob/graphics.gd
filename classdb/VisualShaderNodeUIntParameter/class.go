...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeUIntParameter")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeUIntParameter(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeUIntParameter{gdclass.NewVisualShaderNodeUIntParameter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeUIntParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUIntParameter{gdclass.NewVisualShaderNodeUIntParameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsVisualShaderNodeUIntParameter() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeUIntParameter() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeUIntParameter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeUIntParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeUIntParameter(ptr)} })
}
