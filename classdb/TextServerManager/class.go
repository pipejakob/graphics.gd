...
[TextServerManager]: https://pkg.go.dev/graphics.gd/classdb/TextServerManager
*/
...
func (self class) SetPrimaryInterface(index [1]gdclass.TextServer) { //gd:TextServerManager.set_primary_interface
	...
	runtime.KeepAlive(index[0].Anchor())
}
...
func init() {
	gdclass.Register("TextServerManager", func(ptr gdreference.Object) any { return Instance{gdclass.NewTextServerManager(ptr)} })
}
