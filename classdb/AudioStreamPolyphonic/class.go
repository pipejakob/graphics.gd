...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamPolyphonic{gdclass.NewAudioStreamPolyphonic(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetAudioStreamPolyphonic(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioStreamPolyphonic{gdclass.NewAudioStreamPolyphonic(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetPolyphony() int64 { //gd:AudioStreamPolyphonic.get_polyphony
	var r_ret = jumponly.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_polyphony, gdextension.SizeInt, &struct{}{})
	runtime.KeepAlive(self[0].Anchor())
	var ret = r_ret
	return ret
}
func (o class) AsAudioStreamPolyphonic() Advanced           { return Advanced(o) }
func (o Instance) AsAudioStreamPolyphonic() Instance        { return o }
func (o *Extension[T]) AsAudioStreamPolyphonic() Instance   { return o.Super() }
...
func init() {
	gdclass.Register("AudioStreamPolyphonic", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamPolyphonic(ptr)} })
}
