...
/*
This helper class can be used to store any values on the filesystem using INI-style formatting. The stored values are identified by a section and a key:
...
func init() {
	gdclass.Register("ConfigFile", func(ptr gdreference.Object) any { return Instance{gdclass.NewConfigFile(ptr)} })
}
