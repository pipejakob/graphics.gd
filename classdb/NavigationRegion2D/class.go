...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationRegion2D{gdclass.NewNavigationRegion2D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) NavigationPolygonChanged() Signal.Any {
	return Signal.Via(gd.WrapSignal(gd.NewSignalOf(self.AsObject(), gd.NewStringName(`navigation_polygon_changed`))))
}
