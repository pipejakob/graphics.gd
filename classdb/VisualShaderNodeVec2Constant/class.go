...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVec2Constant{gdclass.NewVisualShaderNodeVec2Constant(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeVec2Constant(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec2Constant{gdclass.NewVisualShaderNodeVec2Constant(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetConstant() Vector2.XY { //gd:VisualShaderNodeVec2Constant.get_constant
	var r_ret = jumponly.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func init() {
	gdclass.Register("VisualShaderNodeVec2Constant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec2Constant(ptr)} })
}
