...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewSphereShape3D(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SphereShape3D{gdclass.NewSphereShape3D(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetSphereShape3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SphereShape3D{gdclass.NewSphereShape3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
*/
func (self Instance) Radius() Float.X { //gd:SphereShape3D.radius
	return Float.X(Float.X(class(self).GetRadius()))
}

// SetRadius sets the property returned by [GetRadius]. Returns the instance, so that property settings can be chained.
func (self Instance) SetRadius(value Float.X) Instance { //gd:SphereShape3D.radius
...
func (o class) AsSphereShape3D() Advanced             { return Advanced(o) }
func (o Instance) AsSphereShape3D() Instance          { return o }
func (o *Extension[T]) AsSphereShape3D() Instance     { return o.Super() }
...
func init() {
	gdclass.Register("SphereShape3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewSphereShape3D(ptr)} })
}
