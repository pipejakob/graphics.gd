...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderTextureLayered{gdclass.NewPlaceholderTextureLayered(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
