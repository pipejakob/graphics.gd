...
type Instance [1]gdclass.StreamPeerSocket

var otype gdextension.ObjectType
var sname gdextension.StringName
var methods struct {
	poll                 gdextension.MethodForClass `hash:"166280745"`
	get_status           gdextension.MethodForClass `hash:"1156122502"`
	disconnect_from_host gdextension.MethodForClass `hash:"3218959716"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("StreamPeerSocket")
...
type Any interface {
	gd.IsClass
	AsStreamPeerSocket() Instance
}

/*
Polls the socket, updating its state. See [GetStatus].

[GetStatus]: https://pkg.go.dev/graphics.gd/classdb/StreamPeerSocket#Instance.GetStatus
*/
func (self Instance) Poll() error { //gd:StreamPeerSocket.poll
...
*/
func (self Instance) GetStatus() Status { //gd:StreamPeerSocket.get_status
...
*/
func (self Instance) DisconnectFromHost() { //gd:StreamPeerSocket.disconnect_from_host
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.StreamPeerSocket{gdclass.NewStreamPeerSocket(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetStreamPeerSocket(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.StreamPeerSocket{gdclass.NewStreamPeerSocket(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func init() {
	gdclass.Register("StreamPeerSocket", func(ptr gdreference.Object) any { return Instance{gdclass.NewStreamPeerSocket(ptr)} })
}
...
const (
	...
	//
	// [StreamPeerSocket]: https://pkg.go.dev/graphics.gd/classdb/StreamPeerSocket
	StatusNone Status = 0
