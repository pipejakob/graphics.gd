...
type Interface interface {
	...
	GetLineSyntaxHighlighting(line int) map[int]Entry
...
[GetLineSyntaxHighlighting]: https://pkg.go.dev/graphics.gd/classdb/SyntaxHighlighter#Instance.GetLineSyntaxHighlighting
*/
func (Instance) _get_line_syntax_highlighting(impl func(ptr gdclass.Receiver, line int) map[int]Entry) (cb gd.ExtensionClassCallVirtualFunc) {
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewSyntaxHighlighter(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SyntaxHighlighter{gdclass.NewSyntaxHighlighter(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetSyntaxHighlighter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SyntaxHighlighter{gdclass.NewSyntaxHighlighter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) GetTextEdit() [1]gdclass.TextEdit { //gd:SyntaxHighlighter.get_text_edit
	var r_ret = jumponly.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_text_edit, gdextension.SizeObject, &struct{}{})
	var ret = [1]gdclass.TextEdit{gdclass.NewTextEdit(gdreference.LetObject(r_ret))}
	return ret
}
func (o class) AsSyntaxHighlighter() Advanced         { return Advanced(o) }
func (o Instance) AsSyntaxHighlighter() Instance      { return o }
func (o *Extension[T]) AsSyntaxHighlighter() Instance { return o.Super() }
...
func init() {
	gdclass.Register("SyntaxHighlighter", func(ptr gdreference.Object) any { return Instance{gdclass.NewSyntaxHighlighter(ptr)} })
}
