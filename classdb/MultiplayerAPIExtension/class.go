...
func (Instance) _rpc(impl func(ptr gdclass.Receiver, peer int, obj Object.Instance, method string, args []any) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		...
		var method = String.Name(String.Via(gd.WrapStringName(pointers.Pin(pointers.New[gd.StringName](gd.UnsafeGet[gdextension.StringName](p_args, 2))))))
		defer pointers.End(gd.InternalStringName(method))
		var args = Array.Through(gd.WrapArray[variant.Any](pointers.Pin(pointers.New[gd.Array](gd.UnsafeGet[gdextension.Array](p_args, 3)))))
...
func (Instance) _object_configuration_add(impl func(ptr gdclass.Receiver, obj Object.Instance, configuration any) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		...
		defer gdreference.EndObject(obj[0])
		var configuration = variant.Implementation(gd.WrapVariant(pointers.Pin(pointers.New[gd.Variant](gd.UnsafeGet[gdextension.Variant](p_args, 1)))))
