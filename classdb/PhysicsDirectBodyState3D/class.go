...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("PhysicsDirectBodyState3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsDirectBodyState3D{gdclass.NewPhysicsDirectBodyState3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
