...
/*
[IntervalTweener] is used to make delays in a tweening sequence. See [Tween.TweenInterval] for more usage information.

Note: [Tween.TweenInterval] is the only correct way to create [IntervalTweener]. Any [IntervalTweener] created manually will not function correctly.

[IntervalTweener]: https://pkg.go.dev/graphics.gd/classdb/IntervalTweener
[Tween.TweenInterval]: https://pkg.go.dev/graphics.gd/classdb/Tween#Instance.TweenInterval
*/
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("IntervalTweener")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewIntervalTweener(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.IntervalTweener{gdclass.NewIntervalTweener(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetIntervalTweener(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.IntervalTweener{gdclass.NewIntervalTweener(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsIntervalTweener() Advanced         { return Advanced(o) }
func (o Instance) AsIntervalTweener() Instance      { return o }
func (o *Extension[T]) AsIntervalTweener() Instance { return o.Super() }
...
func init() {
	gdclass.Register("IntervalTweener", func(ptr gdreference.Object) any { return Instance{gdclass.NewIntervalTweener(ptr)} })
}
