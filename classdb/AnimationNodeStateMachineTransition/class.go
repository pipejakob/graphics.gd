...
func init() {
	gdclass.Register("AnimationNodeStateMachineTransition", func(ptr gdreference.Object) any { return Instance{gdclass.NewAnimationNodeStateMachineTransition(ptr)} })
}
