...
This resource configures an [AudioEffectSpectrumAnalyzerInstance], which performs the actual analysis at runtime. An instance should be obtained with [AudioServer.GetBusEffectInstance] to make use of this effect.
