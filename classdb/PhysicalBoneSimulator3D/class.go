...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicalBoneSimulator3D{gdclass.NewPhysicalBoneSimulator3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
