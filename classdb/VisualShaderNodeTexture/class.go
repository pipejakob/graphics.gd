...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewVisualShaderNodeTexture(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture{gdclass.NewVisualShaderNodeTexture(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetVisualShaderNodeTexture(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture{gdclass.NewVisualShaderNodeTexture(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (self class) SetTexture(value [1]gdclass.Texture2D) { //gd:VisualShaderNodeTexture.set_texture
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_texture, 0|(gdextension.SizeObject<<4), &struct{ value gdextension.Object }{gdextension.Object(gdreference.GetObject(gdclass.GetTexture2D(value[0])[0]))})
	runtime.KeepAlive(self[0].Anchor())
	runtime.KeepAlive(value[0].Anchor())
}
...
func (o class) AsVisualShaderNodeTexture() Advanced         { return Advanced(o) }
func (o Instance) AsVisualShaderNodeTexture() Instance      { return o }
func (o *Extension[T]) AsVisualShaderNodeTexture() Instance { return o.Super() }
...
func init() {
	gdclass.Register("VisualShaderNodeTexture", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTexture(ptr)} })
}
