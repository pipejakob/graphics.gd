...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRAPIExtension{gdclass.NewOpenXRAPIExtension(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetOpenXRAPIExtension(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
...
func init() {
	gdclass.Register("OpenXRAPIExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRAPIExtension(ptr)} })
}
