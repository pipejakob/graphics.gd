...
[Texture]: https://pkg.go.dev/graphics.gd/classdb/Texture
...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("Texture")
...
type Advanced = class
type class [1]gdclass.Texture

func (o class) AsObject() [1]gdreference.Object { return *(*[1]gdreference.Object)(ie.As(&o)) }
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewTexture(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Texture{gdclass.NewTexture(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetTexture(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Texture{gdclass.NewTexture(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
	gd.ObjectNotification(casted.AsObject()[0], 0, false)
	return casted
}

func (o class) AsTexture() Advanced                   { return Advanced(o) }
func (o Instance) AsTexture() Instance                { return o }
func (o *Extension[T]) AsTexture() Instance           { return o.Super() }
...
func init() {
	gdclass.Register("Texture", func(ptr gdreference.Object) any { return Instance{gdclass.NewTexture(ptr)} })
}
