...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DLookAt{gdclass.NewSkeletonModification2DLookAt(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
