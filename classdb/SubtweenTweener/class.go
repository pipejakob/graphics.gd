...
[Tween.TweenSubtween]: https://pkg.go.dev/graphics.gd/classdb/Tween#Instance.TweenSubtween
*/
...
var methods struct {
	set_delay gdextension.MethodForClass `hash:"449181780"`
}

func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("SubtweenTweener")
...
func (self *class) SetObject(obj [1]gdreference.Object) bool {
	if gdextension.Host.Objects.Cast(gdreference.GetObject(obj[0]), otype) != 0 {
		self[0] = gdclass.NewSubtweenTweener(obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SubtweenTweener{gdclass.NewSubtweenTweener(gdreference.NewObject())})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := gdreference.EndObject(New().AsObject()[0])
				gdreference.SetObject(gdclass.GetSubtweenTweener(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SubtweenTweener{gdclass.NewSubtweenTweener(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
...
func (o class) AsSubtweenTweener() Advanced         { return Advanced(o) }
func (o Instance) AsSubtweenTweener() Instance      { return o }
func (o *Extension[T]) AsSubtweenTweener() Instance { return o.Super() }
...
func init() {
	gdclass.Register("SubtweenTweener", func(ptr gdreference.Object) any { return Instance{gdclass.NewSubtweenTweener(ptr)} })
}
