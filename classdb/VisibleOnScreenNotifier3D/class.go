...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisibleOnScreenNotifier3D{gdclass.NewVisibleOnScreenNotifier3D(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
