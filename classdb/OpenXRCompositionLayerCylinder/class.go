...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRCompositionLayerCylinder{gdclass.NewOpenXRCompositionLayerCylinder(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
