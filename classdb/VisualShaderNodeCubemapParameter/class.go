...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.Host.Strings.Intern.UTF8("VisualShaderNodeCubemapParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCubemapParameter{gdclass.NewVisualShaderNodeCubemapParameter(gdreference.OwnObject(gdextension.Host.Objects.Make(sname), gd.Free))})
