...
func (c Converter) String() String.Unicode               { return String.New("testing") }
...
func (c Converter) ValidString(s String.Unicode) bool               { return s.String() == c.String().String() }
...
func (c Converter) ValidObject(o Object.Instance) bool {
	return gd.ObjectGetClass(o.AsObject()[0]).String() == "Object"
}
func (c Converter) ValidNode(o Node.Instance) bool {
	return gd.ObjectGetClass(o.AsObject()[0]).String() == "Converter"
}
